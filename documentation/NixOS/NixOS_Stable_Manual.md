...
| NixOS Manual |
| :---: |
|  |  | [Next](https://nixos.org/manual/nixos/stable/options) |
...
[Preface](https://nixos.org/manual/nixos/stable/#preface)[Installation](https://nixos.org/manual/nixos/stable/#ch-installation)[Obtaining NixOS](https://nixos.org/manual/nixos/stable/#sec-obtaining)[Installing NixOS](https://nixos.org/manual/nixos/stable/#sec-installation)[Changing the Configuration](https://nixos.org/manual/nixos/stable/#sec-changing-config)[Upgrading NixOS](https://nixos.org/manual/nixos/stable/#sec-upgrading)[Building a NixOS (Live) ISO](https://nixos.org/manual/nixos/stable/#sec-building-image)[Building Images with `nixos-rebuild build-image`](https://nixos.org/manual/nixos/stable/#sec-image-nixos-rebuild-build-image)[Building Images via `systemd-repart`](https://nixos.org/manual/nixos/stable/#sec-image-repart)[Configuration](https://nixos.org/manual/nixos/stable/#ch-configuration)[Configuration Syntax](https://nixos.org/manual/nixos/stable/#sec-configuration-syntax)[Package Management](https://nixos.org/manual/nixos/stable/#sec-package-management)[User Management](https://nixos.org/manual/nixos/stable/#sec-user-management)[File Systems](https://nixos.org/manual/nixos/stable/#ch-file-systems)[X Window System](https://nixos.org/manual/nixos/stable/#sec-x11)[Wayland](https://nixos.org/manual/nixos/stable/#sec-wayland)[GPU acceleration](https://nixos.org/manual/nixos/stable/#sec-gpu-accel)[Xfce Desktop Environment](https://nixos.org/manual/nixos/stable/#sec-xfce)[Networking](https://nixos.org/manual/nixos/stable/#sec-networking)[Linux Kernel](https://nixos.org/manual/nixos/stable/#sec-kernel-config)[Subversion](https://nixos.org/manual/nixos/stable/#module-services-subversion)[GNOME Desktop](https://nixos.org/manual/nixos/stable/#chap-gnome)[Pantheon Desktop](https://nixos.org/manual/nixos/stable/#chap-pantheon)[tpm2-totp with Plymouth](https://nixos.org/manual/nixos/stable/#module-boot-plymouth-tpm2-totp)[External Bootloader Backends](https://nixos.org/manual/nixos/stable/#sec-bootloader-external)[Clevis](https://nixos.org/manual/nixos/stable/#module-boot-clevis)[Garage](https://nixos.org/manual/nixos/stable/#module-services-garage)[YouTrack](https://nixos.org/manual/nixos/stable/#module-services-youtrack)[Szurubooru](https://nixos.org/manual/nixos/stable/#module-services-szurubooru)[Suwayomi-Server](https://nixos.org/manual/nixos/stable/#module-services-suwayomi-server)[strfry](https://nixos.org/manual/nixos/stable/#module-services-strfry)[Plausible](https://nixos.org/manual/nixos/stable/#module-services-plausible)[Pingvin Share](https://nixos.org/manual/nixos/stable/#module-services-pingvin-share)[Pi-hole Web Dashboard](https://nixos.org/manual/nixos/stable/#module-services-web-apps-pihole-web)[Pict-rs](https://nixos.org/manual/nixos/stable/#module-services-pict-rs)[OpenCloud](https://nixos.org/manual/nixos/stable/#module-services-opencloud)[Nextcloud](https://nixos.org/manual/nixos/stable/#module-services-nextcloud)[Matomo](https://nixos.org/manual/nixos/stable/#module-services-matomo)[Lemmy](https://nixos.org/manual/nixos/stable/#module-services-lemmy)[Keycloak](https://nixos.org/manual/nixos/stable/#module-services-keycloak)[Jitsi Meet](https://nixos.org/manual/nixos/stable/#module-services-jitsi-meet)[Immich](https://nixos.org/manual/nixos/stable/#module-services-immich)[Honk](https://nixos.org/manual/nixos/stable/#module-services-honk)[Hatsu](https://nixos.org/manual/nixos/stable/#module-services-hatsu)[Grocy](https://nixos.org/manual/nixos/stable/#module-services-grocy)[GoToSocial](https://nixos.org/manual/nixos/stable/#module-services-gotosocial)[Glance](https://nixos.org/manual/nixos/stable/#module-services-glance)[Discourse](https://nixos.org/manual/nixos/stable/#module-services-discourse)[Davis](https://nixos.org/manual/nixos/stable/#module-services-davis)[Castopod](https://nixos.org/manual/nixos/stable/#module-services-castopod)[c2FmZQ](https://nixos.org/manual/nixos/stable/#module-services-c2fmzq)[Akkoma](https://nixos.org/manual/nixos/stable/#module-services-akkoma)[systemd-lock-handler](https://nixos.org/manual/nixos/stable/#module-services-systemd-lock-handler)[kerberos_server](https://nixos.org/manual/nixos/stable/#module-services-kerberos-server)[Meilisearch](https://nixos.org/manual/nixos/stable/#module-services-meilisearch)[Yggdrasil](https://nixos.org/manual/nixos/stable/#module-services-networking-yggdrasil)[uMurmur](https://nixos.org/manual/nixos/stable/#module-service-umurmur)[Prosody](https://nixos.org/manual/nixos/stable/#module-services-prosody)[Pleroma](https://nixos.org/manual/nixos/stable/#module-services-pleroma)[pihole-FTL](https://nixos.org/manual/nixos/stable/#module-services-networking-pihole-ftl)[Netbird server](https://nixos.org/manual/nixos/stable/#module-services-netbird-server)[Netbird](https://nixos.org/manual/nixos/stable/#module-services-netbird)[Mosquitto](https://nixos.org/manual/nixos/stable/#module-services-mosquitto)[Jottacloud Command-line Tool](https://nixos.org/manual/nixos/stable/#module-services-jotta-cli)[GNS3 Server](https://nixos.org/manual/nixos/stable/#module-services-gns3-server)[Firefox Sync server](https://nixos.org/manual/nixos/stable/#module-services-firefox-syncserver)[DNS-over-HTTPS Server](https://nixos.org/manual/nixos/stable/#module-service-doh-server)[Dnsmasq](https://nixos.org/manual/nixos/stable/#module-services-networking-dnsmasq)[🦀 crab-hole](https://nixos.org/manual/nixos/stable/#module-services-crab-hole)[atalkd](https://nixos.org/manual/nixos/stable/#module-services-atalkd)[Anubis](https://nixos.org/manual/nixos/stable/#module-services-anubis)[Samba](https://nixos.org/manual/nixos/stable/#module-services-samba)[Litestream](https://nixos.org/manual/nixos/stable/#module-services-litestream)[Prometheus exporters](https://nixos.org/manual/nixos/stable/#module-services-prometheus-exporters)[parsedmarc](https://nixos.org/manual/nixos/stable/#module-services-parsedmarc)[OCS Inventory Agent](https://nixos.org/manual/nixos/stable/#module-services-ocsinventory-agent)[Goss](https://nixos.org/manual/nixos/stable/#module-services-goss)[Cert Spotter](https://nixos.org/manual/nixos/stable/#module-services-certspotter)[WeeChat](https://nixos.org/manual/nixos/stable/#module-services-weechat)[Taskserver](https://nixos.org/manual/nixos/stable/#module-services-taskserver)[Paisa](https://nixos.org/manual/nixos/stable/#module-services-paisa)[GitLab](https://nixos.org/manual/nixos/stable/#module-services-gitlab)[Forgejo](https://nixos.org/manual/nixos/stable/#module-forgejo)[Dump1090-fa](https://nixos.org/manual/nixos/stable/#module-services-dump1090-fa)[Apache Kafka](https://nixos.org/manual/nixos/stable/#module-services-apache-kafka)[Anki Sync Server](https://nixos.org/manual/nixos/stable/#module-services-anki-sync-server)[Matrix](https://nixos.org/manual/nixos/stable/#module-services-matrix)[Mjolnir (Matrix Moderation Tool)](https://nixos.org/manual/nixos/stable/#module-services-mjolnir)[Mautrix-Whatsapp](https://nixos.org/manual/nixos/stable/#module-services-mautrix-whatsapp)[Mautrix-Signal](https://nixos.org/manual/nixos/stable/#module-services-mautrix-signal)[Maubot](https://nixos.org/manual/nixos/stable/#module-services-maubot)[Draupnir (Matrix Moderation Bot)](https://nixos.org/manual/nixos/stable/#module-services-draupnir)[Mailman](https://nixos.org/manual/nixos/stable/#module-services-mailman)[Trezor](https://nixos.org/manual/nixos/stable/#trezor)[Customizing display configuration](https://nixos.org/manual/nixos/stable/#module-hardware-display)[Emacs](https://nixos.org/manual/nixos/stable/#module-services-emacs)[Livebook](https://nixos.org/manual/nixos/stable/#module-services-livebook)[Blackfire profiler](https://nixos.org/manual/nixos/stable/#module-services-blackfire)[Athens](https://nixos.org/manual/nixos/stable/#module-athens)[Flatpak](https://nixos.org/manual/nixos/stable/#module-services-flatpak)[TigerBeetle](https://nixos.org/manual/nixos/stable/#module-services-tigerbeetle)[PostgreSQL](https://nixos.org/manual/nixos/stable/#module-postgresql)[FoundationDB](https://nixos.org/manual/nixos/stable/#module-services-foundationdb)[BorgBackup](https://nixos.org/manual/nixos/stable/#module-borgbase)[TPM2](https://nixos.org/manual/nixos/stable/#module-security-tpm2)[SSL/TLS Certificates with ACME](https://nixos.org/manual/nixos/stable/#module-security-acme)[Oh my ZSH](https://nixos.org/manual/nixos/stable/#module-programs-zsh-ohmyzsh)[Plotinus](https://nixos.org/manual/nixos/stable/#module-program-plotinus)[Digital Bitbox](https://nixos.org/manual/nixos/stable/#module-programs-digitalbitbox)[Input Methods](https://nixos.org/manual/nixos/stable/#module-services-input-methods)[Profiles](https://nixos.org/manual/nixos/stable/#ch-profiles)[Mattermost](https://nixos.org/manual/nixos/stable/#sec-mattermost)[Kubernetes](https://nixos.org/manual/nixos/stable/#sec-kubernetes)[Administration](https://nixos.org/manual/nixos/stable/#ch-running)[Service Management](https://nixos.org/manual/nixos/stable/#sec-systemctl)[Rebooting and Shutting Down](https://nixos.org/manual/nixos/stable/#sec-rebooting)[User Sessions](https://nixos.org/manual/nixos/stable/#sec-user-sessions)[Control Groups](https://nixos.org/manual/nixos/stable/#sec-cgroups)[Logging](https://nixos.org/manual/nixos/stable/#sec-logging)[Necessary system state](https://nixos.org/manual/nixos/stable/#ch-system-state)[Cleaning the Nix Store](https://nixos.org/manual/nixos/stable/#sec-nix-gc)[Container Management](https://nixos.org/manual/nixos/stable/#ch-containers)[Troubleshooting](https://nixos.org/manual/nixos/stable/#ch-troubleshooting)[Development](https://nixos.org/manual/nixos/stable/#ch-development)[Getting the Sources](https://nixos.org/manual/nixos/stable/#sec-getting-sources)[Writing NixOS Modules](https://nixos.org/manual/nixos/stable/#sec-writing-modules)[Building Specific Parts of NixOS](https://nixos.org/manual/nixos/stable/#sec-building-parts)[Bootspec](https://nixos.org/manual/nixos/stable/#sec-bootspec)[What happens during a system switch?](https://nixos.org/manual/nixos/stable/#sec-switching-systems)[Writing NixOS Documentation](https://nixos.org/manual/nixos/stable/#sec-writing-documentation)[NixOS Tests](https://nixos.org/manual/nixos/stable/#sec-nixos-tests)[Developing the NixOS Test Driver](https://nixos.org/manual/nixos/stable/#chap-developing-the-test-driver)[Testing the Installer](https://nixos.org/manual/nixos/stable/#ch-testing-installer)[Modular Services](https://nixos.org/manual/nixos/stable/#modular-services)[Contributing to this manual](https://nixos.org/manual/nixos/stable/#chap-contributing)[A. Configuration Options](https://nixos.org/manual/nixos/stable/options)[B. Release Notes](https://nixos.org/manual/nixos/stable/release-notes)

**List of Examples**

1. [Example partition schemes for NixOS on `/dev/sda` (MBR)](https://nixos.org/manual/nixos/stable/#ex-partition-scheme-MBR)2. [Example partition schemes for NixOS on `/dev/sda` (UEFI)](https://nixos.org/manual/nixos/stable/#ex-partition-scheme-UEFI)3. [Commands for Installing NixOS on `/dev/sda`](https://nixos.org/manual/nixos/stable/#ex-install-sequence)4. [Example: NixOS Configuration](https://nixos.org/manual/nixos/stable/#ex-config)5. [Customize specific image variants](https://nixos.org/manual/nixos/stable/#ex-nixos-rebuild-build-image-customize)6. [Nix expression to build Emacs with packages (`emacs.nix`)](https://nixos.org/manual/nixos/stable/#ex-emacsNix)7. [Querying Emacs packages](https://nixos.org/manual/nixos/stable/#module-services-emacs-querying-packages)8. [Custom Emacs in `configuration.nix`](https://nixos.org/manual/nixos/stable/#module-services-emacs-configuration-nix)9. [Custom Emacs in `~/.config/nixpkgs/config.nix`](https://nixos.org/manual/nixos/stable/#module-services-emacs-config-nix)10. [Custom Emacs build](https://nixos.org/manual/nixos/stable/#ex-emacsGtk3Nix)11. [Structure of NixOS Modules](https://nixos.org/manual/nixos/stable/#ex-module-syntax)12. [NixOS Module for the “locate” Service](https://nixos.org/manual/nixos/stable/#locate-example)13. [Escaping in Exec directives](https://nixos.org/manual/nixos/stable/#exec-escaping-example)14. [`mkEnableOption` usage](https://nixos.org/manual/nixos/stable/#ex-options-declarations-util-mkEnableOption-magic)15. [Simple `mkPackageOption` usage](https://nixos.org/manual/nixos/stable/#ex-options-declarations-util-mkPackageOption-hello)16. [`mkPackageOption` with explicit default and example](https://nixos.org/manual/nixos/stable/#ex-options-declarations-util-mkPackageOption-ghc)17. [`mkPackageOption` with additional description text](https://nixos.org/manual/nixos/stable/#ex-options-declarations-util-mkPackageOption-extraDescription)18. [Extensible type placeholder in the service module](https://nixos.org/manual/nixos/stable/#ex-option-declaration-eot-service)19. [Extending `services.xserver.displayManager.enable` in the `gdm` module](https://nixos.org/manual/nixos/stable/#ex-option-declaration-eot-backend-gdm)20. [Extending `services.xserver.displayManager.enable` in the `sddm` module](https://nixos.org/manual/nixos/stable/#ex-option-declaration-eot-backend-sddm)21. [`types.anything`](https://nixos.org/manual/nixos/stable/#ex-types-anything)22. [Directly defined submodule](https://nixos.org/manual/nixos/stable/#ex-submodule-direct)23. [Submodule defined as a reference](https://nixos.org/manual/nixos/stable/#ex-submodule-reference)24. [Declaration of a list of submodules](https://nixos.org/manual/nixos/stable/#ex-submodule-listof-declaration)25. [Definition of a list of submodules](https://nixos.org/manual/nixos/stable/#ex-submodule-listof-definition)26. [Declaration of attribute sets of submodules](https://nixos.org/manual/nixos/stable/#ex-submodule-attrsof-declaration)27. [Definition of attribute sets of submodules](https://nixos.org/manual/nixos/stable/#ex-submodule-attrsof-definition)28. [Adding a type check](https://nixos.org/manual/nixos/stable/#ex-extending-type-check-1)29. [Overriding a type check](https://nixos.org/manual/nixos/stable/#ex-extending-type-check-2)30. [Freeform submodule](https://nixos.org/manual/nixos/stable/#ex-freeform-module)31. [Module with conventional `settings` option](https://nixos.org/manual/nixos/stable/#ex-settings-nix-representable)32. [Declaring a type-checked `settings` attribute](https://nixos.org/manual/nixos/stable/#ex-settings-typed-attrs)33. [Using extendNixOS in `passthru.tests` to make `(openssh.tests.overrideAttrs f).tests.nixos` coherent](https://nixos.org/manual/nixos/stable/#ex-nixos-test-extendNixOS)

Preface [](https://nixos.org/manual/nixos/stable/#preface)
==========================================================
...
If you encounter problems, please report them on the [`Discourse`](https://discourse.nixos.org/), the [Matrix room](https://matrix.to/#/%23nix:nixos.org), or on the [`#nixos` channel on Libera.Chat](irc://irc.libera.chat/#nixos). Alternatively, consider [contributing to this manual](https://nixos.org/manual/nixos/stable/#chap-contributing "Contributing to this manual"). Bugs should be reported in [NixOS’ GitHub issue tracker](https://github.com/NixOS/nixpkgs/issues).
...
[Obtaining NixOS](https://nixos.org/manual/nixos/stable/#sec-obtaining)[Installing NixOS](https://nixos.org/manual/nixos/stable/#sec-installation)[Changing the Configuration](https://nixos.org/manual/nixos/stable/#sec-changing-config)[Upgrading NixOS](https://nixos.org/manual/nixos/stable/#sec-upgrading)[Building a NixOS (Live) ISO](https://nixos.org/manual/nixos/stable/#sec-building-image)[Building Images with `nixos-rebuild build-image`](https://nixos.org/manual/nixos/stable/#sec-image-nixos-rebuild-build-image)[Building Images via `systemd-repart`](https://nixos.org/manual/nixos/stable/#sec-image-repart)

Obtaining NixOS [](https://nixos.org/manual/nixos/stable/#sec-obtaining)
------------------------------------------------------------------------

NixOS ISO images can be downloaded from the [NixOS download page](https://nixos.org/download.html#nixos-iso). Follow the instructions in [the section called “Booting from a USB flash drive”](https://nixos.org/manual/nixos/stable/#sec-booting-from-usb "Booting from a USB flash drive") to create a bootable USB flash drive.
...
[Booting from the install medium](https://nixos.org/manual/nixos/stable/#sec-installation-booting)[Graphical Installation](https://nixos.org/manual/nixos/stable/#sec-installation-graphical)[Manual Installation](https://nixos.org/manual/nixos/stable/#sec-installation-manual)[Additional installation notes](https://nixos.org/manual/nixos/stable/#sec-installation-additional-notes)
...
For Apple computers with Intel processors press and hold the **⌥** (Option or Alt) key until you see the boot menu. On Apple silicon press and hold the power button. ### Note

If your computer supports both BIOS and UEFI boot, choose the UEFI option. You will likely need to disable “Secure Boot” to use the UEFI option. The exact steps vary by device manufacturer but generally “Secure Boot” will be listed under “Boot”, “Security” or “Advanced” in the BIOS/UEFI menu. ### Note
...
4.   The graphical images will start their corresponding desktop environment and the graphical installer, which can take some time. The minimal images will boot to a command line. You have to follow the instructions in [the section called “Manual Installation”](https://nixos.org/manual/nixos/stable/#sec-installation-manual "Manual Installation") there.
...
At the top left you see if the Installer was booted with BIOS or UEFI. If you know your system supports UEFI and it shows “BIOS”, reboot with the correct option. ### Warning
...
### Partitioning and formatting [](https://nixos.org/manual/nixos/stable/#sec-installation-manual-partitioning)
...
Once complete, you can follow with [the section called “Formatting”](https://nixos.org/manual/nixos/stable/#sec-installation-manual-partitioning-formatting "Formatting").

#### Legacy Boot (MBR) [](https://nixos.org/manual/nixos/stable/#sec-installation-manual-partitioning-MBR)
...
```
2.   Add the _root_ partition. This will fill the disk except for the end part, where the swap will live.
...
#### Formatting [](https://nixos.org/manual/nixos/stable/#sec-installation-manual-partitioning-formatting)
...
### Installing [](https://nixos.org/manual/nixos/stable/#sec-installation-manual-installing)
...
# swapon /dev/sda2
```
4.   You now need to create a file `/mnt/etc/nixos/configuration.nix` that specifies the intended configuration of the system. This is because NixOS has a _declarative_ configuration model: you create or edit a description of the desired configuration of your system, and then NixOS takes care of making it happen. The syntax of the NixOS configuration file is described in [_Configuration Syntax_](https://nixos.org/manual/nixos/stable/#sec-configuration-syntax "Configuration Syntax"), while a list of available configuration options appears in [Appendix A](https://nixos.org/manual/nixos/stable/options "Appendix A. Configuration Options"). A minimal example is shown in [Example: NixOS Configuration](https://nixos.org/manual/nixos/stable/#ex-config "Example 4. Example: NixOS Configuration").
...
BIOS systems
You _must_ set the option [`boot.loader.grub.device`](https://nixos.org/manual/nixos/stable/options#opt-boot.loader.grub.device) to specify on which disk the GRUB boot loader is to be installed. Without it, NixOS cannot boot.

If there are other operating systems running on the machine before installing NixOS, the [`boot.loader.grub.useOSProber`](https://nixos.org/manual/nixos/stable/options#opt-boot.loader.grub.useOSProber) option can be set to `true` to automatically add them to the grub menu.
...
You may want to look at the options starting with [`boot.loader.efi`](https://nixos.org/manual/nixos/stable/options#opt-boot.loader.efi.canTouchEfiVariables) and [`boot.loader.systemd-boot`](https://nixos.org/manual/nixos/stable/options#opt-boot.loader.systemd-boot.enable) as well.

If you want to use GRUB, set [`boot.loader.grub.device`](https://nixos.org/manual/nixos/stable/options#opt-boot.loader.grub.device) to `nodev` and [`boot.loader.grub.efiSupport`](https://nixos.org/manual/nixos/stable/options#opt-boot.loader.grub.efiSupport) to `true`.
...
# reboot
```
7.   You should now be able to boot into the installed NixOS. The GRUB boot menu shows a list of _available configurations_ (initially just one). Every time you change the NixOS configuration (see [Changing Configuration](https://nixos.org/manual/nixos/stable/#sec-changing-config "Changing the Configuration")), a new item is added to the menu. This allows you to easily roll back to a previous configuration if something goes wrong.
...
Some graphical display managers such as SDDM do not allow `root` login by default, so you might need to switch to TTY. Refer to [_User Management_](https://nixos.org/manual/nixos/stable/#sec-user-management "User Management") for details on declaring user accounts. 
You may also want to install some software. This will be covered in [_Package Management_](https://nixos.org/manual/nixos/stable/#sec-package-management "Package Management").

### Installation summary [](https://nixos.org/manual/nixos/stable/#sec-installation-manual-summary)

To summarise, [Example: Commands for Installing NixOS on `/dev/sda`](https://nixos.org/manual/nixos/stable/#ex-install-sequence "Example 3. Commands for Installing NixOS on /dev/sda") shows a typical sequence of commands for installing NixOS on an empty hard drive (here `/dev/sda`). [Example: NixOS Configuration](https://nixos.org/manual/nixos/stable/#ex-config "Example 4. Example: NixOS Configuration") shows a corresponding configuration Nix expression.
...
### Booting from a USB flash drive [](https://nixos.org/manual/nixos/stable/#sec-booting-from-usb)
...
#### Creating bootable USB flash drive with a graphical tool [](https://nixos.org/manual/nixos/stable/#sec-booting-from-usb-graphical)
...
#### Creating bootable USB flash drive from a Terminal on macOS [](https://nixos.org/manual/nixos/stable/#sec-booting-from-usb-macos)
...
### Booting from the “netboot” media (PXE) [](https://nixos.org/manual/nixos/stable/#sec-booting-from-pxe)
...
### “Booting” into NixOS via kexec [](https://nixos.org/manual/nixos/stable/#sec-booting-via-kexec)
...
### Installing in a VirtualBox guest [](https://nixos.org/manual/nixos/stable/#sec-installing-virtualbox-guest)
...
At this point it is time to prepare your target partition. Please refer to the partitioning, file-system creation, and mounting steps of [_Installing NixOS_](https://nixos.org/manual/nixos/stable/#sec-installation "Installing NixOS")
...
You’ll probably want to edit the configuration files. Refer to the `nixos-generate-config` step in [_Installing NixOS_](https://nixos.org/manual/nixos/stable/#sec-installation "Installing NixOS") for more information.
...
Once you complete this step, you might no longer be able to boot on existing systems without the help of a rescue USB drive or similar. ### Note
...
Again, please refer to the `nixos-install` step in [_Installing NixOS_](https://nixos.org/manual/nixos/stable/#sec-installation "Installing NixOS") for more information.
...
### Installing behind a proxy [](https://nixos.org/manual/nixos/stable/#sec-installing-behind-proxy)
...
If you are switching networks with different proxy configurations, use the `specialisation` option in `configuration.nix` to switch proxies at runtime. Refer to [Appendix A](https://nixos.org/manual/nixos/stable/options "Appendix A. Configuration Options") for more information.

Changing the Configuration [](https://nixos.org/manual/nixos/stable/#sec-changing-config)
-----------------------------------------------------------------------------------------

The file `/etc/nixos/configuration.nix` contains the current configuration of your machine. Whenever you’ve [changed something](https://nixos.org/manual/nixos/stable/#ch-configuration "Configuration") in that file, you should do
...
*   _Small channels_, such as [`nixos-25.11-small`](https://channels.nixos.org/nixos-25.11-small) or [`nixos-unstable-small`](https://channels.nixos.org/nixos-unstable-small). These are identical to the stable and unstable channels described above, except that they contain fewer binary packages. This means they get updated faster than the regular channels (for instance, when a critical security patch is committed to NixOS’s source tree), but may require more packages to be built from source than usual. They’re mostly intended for server environments and as such contain few GUI applications.
...
[Practical Instructions](https://nixos.org/manual/nixos/stable/#sec-building-image-instructions)[Additional drivers or firmware](https://nixos.org/manual/nixos/stable/#sec-building-image-drivers)[Technical Notes](https://nixos.org/manual/nixos/stable/#sec-building-image-tech-notes)

Default live installer configurations are available inside `nixos/modules/installer/cd-dvd`. For building other system images, see [Building Images with `nixos-rebuild build-image`](https://nixos.org/manual/nixos/stable/#sec-image-nixos-rebuild-build-image "Building Images with nixos-rebuild build-image").
...
The `image.modules` option can be used to set specific options per image variant, in a similar fashion as [specialisations](https://nixos.org/manual/nixos/stable/options#opt-specialisation) for generic NixOS configurations.
...
[Nix Store Paths](https://nixos.org/manual/nixos/stable/#sec-image-repart-store-paths)[Appliance Image](https://nixos.org/manual/nixos/stable/#sec-image-repart-appliance)
...
### Nix Store Partition [](https://nixos.org/manual/nixos/stable/#sec-image-repart-store-partition)
...
### Nix Store Subvolume [](https://nixos.org/manual/nixos/stable/#sec-image-repart-store-subvolume)
...
Configuration [](https://nixos.org/manual/nixos/stable/#ch-configuration)
=========================================================================

This chapter describes how to configure various aspects of a NixOS machine through the configuration file `/etc/nixos/configuration.nix`. As described in [_Changing the Configuration_](https://nixos.org/manual/nixos/stable/#sec-changing-config "Changing the Configuration"), changes to this file only take effect after you run **nixos-rebuild**.

**Table of Contents**

[Configuration Syntax](https://nixos.org/manual/nixos/stable/#sec-configuration-syntax)[Package Management](https://nixos.org/manual/nixos/stable/#sec-package-management)[User Management](https://nixos.org/manual/nixos/stable/#sec-user-management)[File Systems](https://nixos.org/manual/nixos/stable/#ch-file-systems)[X Window System](https://nixos.org/manual/nixos/stable/#sec-x11)[Wayland](https://nixos.org/manual/nixos/stable/#sec-wayland)[GPU acceleration](https://nixos.org/manual/nixos/stable/#sec-gpu-accel)[Xfce Desktop Environment](https://nixos.org/manual/nixos/stable/#sec-xfce)[Networking](https://nixos.org/manual/nixos/stable/#sec-networking)[Linux Kernel](https://nixos.org/manual/nixos/stable/#sec-kernel-config)[Subversion](https://nixos.org/manual/nixos/stable/#module-services-subversion)[GNOME Desktop](https://nixos.org/manual/nixos/stable/#chap-gnome)[Pantheon Desktop](https://nixos.org/manual/nixos/stable/#chap-pantheon)[tpm2-totp with Plymouth](https://nixos.org/manual/nixos/stable/#module-boot-plymouth-tpm2-totp)[External Bootloader Backends](https://nixos.org/manual/nixos/stable/#sec-bootloader-external)[Clevis](https://nixos.org/manual/nixos/stable/#module-boot-clevis)[Garage](https://nixos.org/manual/nixos/stable/#module-services-garage)[YouTrack](https://nixos.org/manual/nixos/stable/#module-services-youtrack)[Szurubooru](https://nixos.org/manual/nixos/stable/#module-services-szurubooru)[Suwayomi-Server](https://nixos.org/manual/nixos/stable/#module-services-suwayomi-server)[strfry](https://nixos.org/manual/nixos/stable/#module-services-strfry)[Plausible](https://nixos.org/manual/nixos/stable/#module-services-plausible)[Pingvin Share](https://nixos.org/manual/nixos/stable/#module-services-pingvin-share)[Pi-hole Web Dashboard](https://nixos.org/manual/nixos/stable/#module-services-web-apps-pihole-web)[Pict-rs](https://nixos.org/manual/nixos/stable/#module-services-pict-rs)[OpenCloud](https://nixos.org/manual/nixos/stable/#module-services-opencloud)[Nextcloud](https://nixos.org/manual/nixos/stable/#module-services-nextcloud)[Matomo](https://nixos.org/manual/nixos/stable/#module-services-matomo)[Lemmy](https://nixos.org/manual/nixos/stable/#module-services-lemmy)[Keycloak](https://nixos.org/manual/nixos/stable/#module-services-keycloak)[Jitsi Meet](https://nixos.org/manual/nixos/stable/#module-services-jitsi-meet)[Immich](https://nixos.org/manual/nixos/stable/#module-services-immich)[Honk](https://nixos.org/manual/nixos/stable/#module-services-honk)[Hatsu](https://nixos.org/manual/nixos/stable/#module-services-hatsu)[Grocy](https://nixos.org/manual/nixos/stable/#module-services-grocy)[GoToSocial](https://nixos.org/manual/nixos/stable/#module-services-gotosocial)[Glance](https://nixos.org/manual/nixos/stable/#module-services-glance)[Discourse](https://nixos.org/manual/nixos/stable/#module-services-discourse)[Davis](https://nixos.org/manual/nixos/stable/#module-services-davis)[Castopod](https://nixos.org/manual/nixos/stable/#module-services-castopod)[c2FmZQ](https://nixos.org/manual/nixos/stable/#module-services-c2fmzq)[Akkoma](https://nixos.org/manual/nixos/stable/#module-services-akkoma)[systemd-lock-handler](https://nixos.org/manual/nixos/stable/#module-services-systemd-lock-handler)[kerberos_server](https://nixos.org/manual/nixos/stable/#module-services-kerberos-server)[Meilisearch](https://nixos.org/manual/nixos/stable/#module-services-meilisearch)[Yggdrasil](https://nixos.org/manual/nixos/stable/#module-services-networking-yggdrasil)[uMurmur](https://nixos.org/manual/nixos/stable/#module-service-umurmur)[Prosody](https://nixos.org/manual/nixos/stable/#module-services-prosody)[Pleroma](https://nixos.org/manual/nixos/stable/#module-services-pleroma)[pihole-FTL](https://nixos.org/manual/nixos/stable/#module-services-networking-pihole-ftl)[Netbird server](https://nixos.org/manual/nixos/stable/#module-services-netbird-server)[Netbird](https://nixos.org/manual/nixos/stable/#module-services-netbird)[Mosquitto](https://nixos.org/manual/nixos/stable/#module-services-mosquitto)[Jottacloud Command-line Tool](https://nixos.org/manual/nixos/stable/#module-services-jotta-cli)[GNS3 Server](https://nixos.org/manual/nixos/stable/#module-services-gns3-server)[Firefox Sync server](https://nixos.org/manual/nixos/stable/#module-services-firefox-syncserver)[DNS-over-HTTPS Server](https://nixos.org/manual/nixos/stable/#module-service-doh-server)[Dnsmasq](https://nixos.org/manual/nixos/stable/#module-services-networking-dnsmasq)[🦀 crab-hole](https://nixos.org/manual/nixos/stable/#module-services-crab-hole)[atalkd](https://nixos.org/manual/nixos/stable/#module-services-atalkd)[Anubis](https://nixos.org/manual/nixos/stable/#module-services-anubis)[Samba](https://nixos.org/manual/nixos/stable/#module-services-samba)[Litestream](https://nixos.org/manual/nixos/stable/#module-services-litestream)[Prometheus exporters](https://nixos.org/manual/nixos/stable/#module-services-prometheus-exporters)[parsedmarc](https://nixos.org/manual/nixos/stable/#module-services-parsedmarc)[OCS Inventory Agent](https://nixos.org/manual/nixos/stable/#module-services-ocsinventory-agent)[Goss](https://nixos.org/manual/nixos/stable/#module-services-goss)[Cert Spotter](https://nixos.org/manual/nixos/stable/#module-services-certspotter)[WeeChat](https://nixos.org/manual/nixos/stable/#module-services-weechat)[Taskserver](https://nixos.org/manual/nixos/stable/#module-services-taskserver)[Paisa](https://nixos.org/manual/nixos/stable/#module-services-paisa)[GitLab](https://nixos.org/manual/nixos/stable/#module-services-gitlab)[Forgejo](https://nixos.org/manual/nixos/stable/#module-forgejo)[Dump1090-fa](https://nixos.org/manual/nixos/stable/#module-services-dump1090-fa)[Apache Kafka](https://nixos.org/manual/nixos/stable/#module-services-apache-kafka)[Anki Sync Server](https://nixos.org/manual/nixos/stable/#module-services-anki-sync-server)[Matrix](https://nixos.org/manual/nixos/stable/#module-services-matrix)[Mjolnir (Matrix Moderation Tool)](https://nixos.org/manual/nixos/stable/#module-services-mjolnir)[Mautrix-Whatsapp](https://nixos.org/manual/nixos/stable/#module-services-mautrix-whatsapp)[Mautrix-Signal](https://nixos.org/manual/nixos/stable/#module-services-mautrix-signal)[Maubot](https://nixos.org/manual/nixos/stable/#module-services-maubot)[Draupnir (Matrix Moderation Bot)](https://nixos.org/manual/nixos/stable/#module-services-draupnir)[Mailman](https://nixos.org/manual/nixos/stable/#module-services-mailman)[Trezor](https://nixos.org/manual/nixos/stable/#trezor)[Customizing display configuration](https://nixos.org/manual/nixos/stable/#module-hardware-display)[Emacs](https://nixos.org/manual/nixos/stable/#module-services-emacs)[Livebook](https://nixos.org/manual/nixos/stable/#module-services-livebook)[Blackfire profiler](https://nixos.org/manual/nixos/stable/#module-services-blackfire)[Athens](https://nixos.org/manual/nixos/stable/#module-athens)[Flatpak](https://nixos.org/manual/nixos/stable/#module-services-flatpak)[TigerBeetle](https://nixos.org/manual/nixos/stable/#module-services-tigerbeetle)[PostgreSQL](https://nixos.org/manual/nixos/stable/#module-postgresql)[FoundationDB](https://nixos.org/manual/nixos/stable/#module-services-foundationdb)[BorgBackup](https://nixos.org/manual/nixos/stable/#module-borgbase)[TPM2](https://nixos.org/manual/nixos/stable/#module-security-tpm2)[SSL/TLS Certificates with ACME](https://nixos.org/manual/nixos/stable/#module-security-acme)[Oh my ZSH](https://nixos.org/manual/nixos/stable/#module-programs-zsh-ohmyzsh)[Plotinus](https://nixos.org/manual/nixos/stable/#module-program-plotinus)[Digital Bitbox](https://nixos.org/manual/nixos/stable/#module-programs-digitalbitbox)[Input Methods](https://nixos.org/manual/nixos/stable/#module-services-input-methods)[Profiles](https://nixos.org/manual/nixos/stable/#ch-profiles)[Mattermost](https://nixos.org/manual/nixos/stable/#sec-mattermost)[Kubernetes](https://nixos.org/manual/nixos/stable/#sec-kubernetes)
...
[NixOS Configuration File](https://nixos.org/manual/nixos/stable/#sec-configuration-file)[Abstractions](https://nixos.org/manual/nixos/stable/#sec-module-abstractions)[Modularity](https://nixos.org/manual/nixos/stable/#sec-modularity)
...
The latter option definition changes the default PostgreSQL package used by NixOS’s PostgreSQL service to 14.x. For more information on packages, including how to add new ones, see [the section called “Adding Custom Packages”](https://nixos.org/manual/nixos/stable/#sec-custom-packages "Adding Custom Packages").
...
[Declarative Package Management](https://nixos.org/manual/nixos/stable/#sec-declarative-package-mgmt)[Ad-Hoc Package Management](https://nixos.org/manual/nixos/stable/#sec-ad-hoc-packages)
...
Some packages require additional global configuration such as D-Bus or systemd service registration so adding them to [`environment.systemPackages`](https://nixos.org/manual/nixos/stable/options#opt-environment.systemPackages) might not be sufficient. You are advised to check the [list of options](https://nixos.org/manual/nixos/stable/options "Appendix A. Configuration Options") whether a NixOS module for the package does not exist.
...
### Customising Packages [](https://nixos.org/manual/nixos/stable/#sec-customising-packages)
...
### Adding Custom Packages [](https://nixos.org/manual/nixos/stable/#sec-custom-packages)
...
#### Building with Nix [](https://nixos.org/manual/nixos/stable/#sec-custom-packages-nix)
...
#### Using pre-built executables [](https://nixos.org/manual/nixos/stable/#sec-custom-packages-prebuilt)

Most pre-built executables will not work on NixOS. There are two notable exceptions: flatpaks and AppImages. For flatpaks see the [dedicated section](https://nixos.org/manual/nixos/stable/#module-services-flatpak "Flatpak"). AppImages can run “as-is” on NixOS.
...
[Create users and groups with `systemd-sysusers`](https://nixos.org/manual/nixos/stable/#sec-systemd-sysusers)[Manage users and groups with `userborn`](https://nixos.org/manual/nixos/stable/#sec-userborn)[Restrict usage time](https://nixos.org/manual/nixos/stable/#sec-restrict-usage-time)
...
Please consider using [Userborn](https://nixos.org/manual/nixos/stable/#sec-userborn "Manage users and groups with userborn") over systemd-sysusers as it’s more feature complete.
...
[LUKS-Encrypted File Systems](https://nixos.org/manual/nixos/stable/#sec-luks-file-systems)[SSHFS File Systems](https://nixos.org/manual/nixos/stable/#sec-sshfs-file-systems)[Overlayfs](https://nixos.org/manual/nixos/stable/#sec-overlayfs)
...
#### Without systemd in initrd [](https://nixos.org/manual/nixos/stable/#sec-luks-file-systems-fido2-legacy)
...
#### systemd Stage 1 [](https://nixos.org/manual/nixos/stable/#sec-luks-file-systems-fido2-systemd)
...
### Interactive mounting [](https://nixos.org/manual/nixos/stable/#sec-sshfs-interactive)
...
### Non-interactive mounting [](https://nixos.org/manual/nixos/stable/#sec-sshfs-non-interactive)
...
#### Troubleshooting [](https://nixos.org/manual/nixos/stable/#sec-sshfs-troubleshooting)
...
[Auto-login](https://nixos.org/manual/nixos/stable/#sec-x11-auto-login)[Running X without a display manager](https://nixos.org/manual/nixos/stable/#sec-x11-startx)[Intel Graphics drivers](https://nixos.org/manual/nixos/stable/#sec-x11--graphics-cards-intel)[Proprietary NVIDIA drivers](https://nixos.org/manual/nixos/stable/#sec-x11-graphics-cards-nvidia)[Touchpads](https://nixos.org/manual/nixos/stable/#sec-x11-touchpads)[GTK/Qt themes](https://nixos.org/manual/nixos/stable/#sec-x11-gtk-and-qt-themes)[Custom XKB layouts](https://nixos.org/manual/nixos/stable/#custom-xkb-layouts)
...
The driver has many options (see [Appendix A](https://nixos.org/manual/nixos/stable/options "Appendix A. Configuration Options")). For instance, the following disables tap-to-click behavior:
...
[OpenCL](https://nixos.org/manual/nixos/stable/#sec-gpu-accel-opencl)[Vulkan](https://nixos.org/manual/nixos/stable/#sec-gpu-accel-vulkan)[VA-API](https://nixos.org/manual/nixos/stable/#sec-gpu-accel-va-api)[Common issues](https://nixos.org/manual/nixos/stable/#sec-gpu-accel-common-issues)
...
### AMD [](https://nixos.org/manual/nixos/stable/#sec-gpu-accel-opencl-amd)
...
### Intel [](https://nixos.org/manual/nixos/stable/#sec-gpu-accel-opencl-intel)
...
### AMD [](https://nixos.org/manual/nixos/stable/#sec-gpu-accel-vulkan-amd)
...
### Intel [](https://nixos.org/manual/nixos/stable/#sec-gpu-accel-va-api-intel)
...
### User permissions [](https://nixos.org/manual/nixos/stable/#sec-gpu-accel-common-issues-permissions)
...
### Mixing different versions of nixpkgs [](https://nixos.org/manual/nixos/stable/#sec-gpu-accel-common-issues-mixing-nixpkgs)
...
[Thunar](https://nixos.org/manual/nixos/stable/#sec-xfce-thunar-plugins)[Troubleshooting](https://nixos.org/manual/nixos/stable/#sec-xfce-troubleshooting)
...
[NetworkManager](https://nixos.org/manual/nixos/stable/#sec-networkmanager)[Secure Shell Access](https://nixos.org/manual/nixos/stable/#sec-ssh)[IPv4 Configuration](https://nixos.org/manual/nixos/stable/#sec-ipv4)[IPv6 Configuration](https://nixos.org/manual/nixos/stable/#sec-ipv6)[Firewall](https://nixos.org/manual/nixos/stable/#sec-firewall)[Wireless Networks](https://nixos.org/manual/nixos/stable/#sec-wireless)[Ad-Hoc Configuration](https://nixos.org/manual/nixos/stable/#ad-hoc-network-config)[Renaming network interfaces](https://nixos.org/manual/nixos/stable/#sec-rename-ifs)
...
IPv6 is enabled by default. Stateless address autoconfiguration is used to automatically assign IPv6 addresses to all interfaces, and Privacy Extensions (RFC 4941) are enabled by default. You can adjust the default for this by setting [`networking.tempAddresses`](https://nixos.org/manual/nixos/stable/options#opt-networking.tempAddresses). This option may be overridden on a per-interface basis by [`networking.interfaces.<name>.tempAddress`](https://nixos.org/manual/nixos/stable/options#opt-networking.interfaces._name_.tempAddress). You can disable IPv6 support globally by setting:
...
See [the section called “IPv4 Configuration”](https://nixos.org/manual/nixos/stable/#sec-ipv4 "IPv4 Configuration") for similar examples and additional information.
...
### Assigning custom names [](https://nixos.org/manual/nixos/stable/#sec-custom-ifnames)
...
[Building a custom kernel](https://nixos.org/manual/nixos/stable/#sec-linux-config-customizing)[Rust](https://nixos.org/manual/nixos/stable/#sec-linux-rust)[Developing kernel modules](https://nixos.org/manual/nixos/stable/#sec-linux-config-developing-modules)[ZFS](https://nixos.org/manual/nixos/stable/#sec-linux-zfs)
...
If you want to change the kernel configuration, you can use the `packageOverrides` feature (see [the section called “Customising Packages”](https://nixos.org/manual/nixos/stable/#sec-customising-packages "Customising Packages")). For instance, to enable support for the kernel debugger KGDB:
...
[Enabling GNOME](https://nixos.org/manual/nixos/stable/#sec-gnome-enable)[Enabling GNOME Flashback](https://nixos.org/manual/nixos/stable/#sec-gnome-enable-flashback)[Icons and GTK Themes](https://nixos.org/manual/nixos/stable/#sec-gnome-icons-and-gtk-themes)[Shell Extensions](https://nixos.org/manual/nixos/stable/#sec-gnome-shell-extensions)[GSettings Overrides](https://nixos.org/manual/nixos/stable/#sec-gnome-gsettings-overrides)[Frequently Asked Questions](https://nixos.org/manual/nixos/stable/#sec-gnome-faq)
...
While it is not strictly necessary to use GDM as the display manager with GNOME, it is recommended, as some features such as screen lock [might not work](https://nixos.org/manual/nixos/stable/#sec-gnome-faq-can-i-use-lightdm-with-gnome "Can I use LightDM with GNOME?") without it.
...
### GNOME without the apps [](https://nixos.org/manual/nixos/stable/#sec-gnome-without-the-apps)
...
### Disabling GNOME services [](https://nixos.org/manual/nixos/stable/#sec-gnome-disabling-services)
...
### GNOME games [](https://nixos.org/manual/nixos/stable/#sec-gnome-games)
...
### GNOME core developer tools [](https://nixos.org/manual/nixos/stable/#sec-gnome-core-developer-tools)
...
Unfortunately, we lack a way for these to be managed in a completely declarative way. So you have to enable them manually with an Extensions application. It is possible to use a [GSettings override](https://nixos.org/manual/nixos/stable/#sec-gnome-gsettings-overrides "GSettings Overrides") for this on `org.gnome.shell.enabled-extensions`, but that will only influence the default value.
...
### Example [](https://nixos.org/manual/nixos/stable/#sec-gnome-gsettings-overrides-example)
...
### Can I use LightDM with GNOME? [](https://nixos.org/manual/nixos/stable/#sec-gnome-faq-can-i-use-lightdm-with-gnome)
...
[Enabling Pantheon](https://nixos.org/manual/nixos/stable/#sec-pantheon-enable)[Wingpanel and Switchboard plugins](https://nixos.org/manual/nixos/stable/#sec-pantheon-wingpanel-switchboard)[FAQ](https://nixos.org/manual/nixos/stable/#sec-pantheon-faq)
...
If you are using Pantheon, AppCenter should be installed by default if you have [Flatpak support](https://nixos.org/manual/nixos/stable/#module-services-flatpak "Flatpak") enabled. If you also wish to add the `appcenter` Flatpak remote:
...
### 1. Enable modules [](https://nixos.org/manual/nixos/stable/#module-boot-plymouth-tpm2-totp-quick-start-enable)
...
### 2. Configure `tpm2-totp`[](https://nixos.org/manual/nixos/stable/#module-boot-plymouth-tpm2-totp-quick-start-configure)
...
### 3. Check configuration [](https://nixos.org/manual/nixos/stable/#module-boot-plymouth-tpm2-totp-quick-start-check)
...
[Create a JWE file containing your secret](https://nixos.org/manual/nixos/stable/#module-boot-clevis-create-secret)[Activate unattended decryption of a resource at boot](https://nixos.org/manual/nixos/stable/#module-boot-clevis-activate)
...
[General considerations on upgrades](https://nixos.org/manual/nixos/stable/#module-services-garage-upgrade-scenarios)[Advanced upgrades (minor/major version upgrades)](https://nixos.org/manual/nixos/stable/#module-services-garage-advanced-upgrades)[Maintainer information](https://nixos.org/manual/nixos/stable/#module-services-garage-maintainer-info)
...
[Installation](https://nixos.org/manual/nixos/stable/#module-services-youtrack-installation)[Upgrade from 2022.3 to 2023.x](https://nixos.org/manual/nixos/stable/#module-services-youtrack-upgrade-2022_3-2023_1)
...
[Configuration](https://nixos.org/manual/nixos/stable/#module-services-szurubooru-basic-usage)[Reverse proxy configuration](https://nixos.org/manual/nixos/stable/#module-services-szurubooru-reverse-proxy-configuration)[Extra configuration](https://nixos.org/manual/nixos/stable/#module-services-szurubooru-extra-config)
...
[Basic usage](https://nixos.org/manual/nixos/stable/#module-services-suwayomi-server-basic-usage)[Basic authentication](https://nixos.org/manual/nixos/stable/#module-services-suwayomi-server-basic-auth)[Extra configuration](https://nixos.org/manual/nixos/stable/#module-services-suwayomi-server-extra-config)
...
[Basic usage](https://nixos.org/manual/nixos/stable/#module-services-strfry-basic-usage)[Reverse Proxy](https://nixos.org/manual/nixos/stable/#module-services-strfry-reverse-proxy)
...
[Configuration](https://nixos.org/manual/nixos/stable/#module-services-pingvin-share-basic-usage)[Reverse proxy configuration](https://nixos.org/manual/nixos/stable/#module-services-pingvin-share-reverse-proxy-configuration)
...
[Quickstart](https://nixos.org/manual/nixos/stable/#module-services-pict-rs-quickstart)[Usage](https://nixos.org/manual/nixos/stable/#module-services-pict-rs-usage)[Missing](https://nixos.org/manual/nixos/stable/#module-services-pict-rs-missing)
...
[Basic usage](https://nixos.org/manual/nixos/stable/#module-services-nextcloud-basic-usage)[`nextcloud-occ`](https://nixos.org/manual/nixos/stable/#module-services-nextcloud-occ)[Common problems](https://nixos.org/manual/nixos/stable/#module-services-nextcloud-pitfalls-during-upgrade)[Using an alternative webserver as reverse-proxy (e.g. `httpd`)](https://nixos.org/manual/nixos/stable/#module-services-nextcloud-httpd)[Installing Apps and PHP extensions](https://nixos.org/manual/nixos/stable/#installing-apps-php-extensions-nextcloud)[Known warnings](https://nixos.org/manual/nixos/stable/#module-services-nextcloud-known-warnings)[Maintainer information](https://nixos.org/manual/nixos/stable/#module-services-nextcloud-maintainer-info)
...
Don’t delete `config.php`! This file tracks the application’s state and a deletion can cause unwanted side-effects! ### Warning
...
### Logreader application only supports “file” log_type [](https://nixos.org/manual/nixos/stable/#module-services-nextcloud-warning-logreader)
...
[Database Setup](https://nixos.org/manual/nixos/stable/#module-services-matomo-database-setup)[Archive Processing](https://nixos.org/manual/nixos/stable/#module-services-matomo-archive-processing)[Backup](https://nixos.org/manual/nixos/stable/#module-services-matomo-backups)[Issues](https://nixos.org/manual/nixos/stable/#module-services-matomo-issues)[Using other Web Servers than nginx](https://nixos.org/manual/nixos/stable/#module-services-matomo-other-web-servers)
...
[Quickstart](https://nixos.org/manual/nixos/stable/#module-services-lemmy-quickstart)[Usage](https://nixos.org/manual/nixos/stable/#module-services-lemmy-usage)[Missing](https://nixos.org/manual/nixos/stable/#module-services-lemmy-missing)
...
[Administration](https://nixos.org/manual/nixos/stable/#module-services-keycloak-admin)[Database access](https://nixos.org/manual/nixos/stable/#module-services-keycloak-database)[Hostname](https://nixos.org/manual/nixos/stable/#module-services-keycloak-hostname)[Setting up TLS/SSL](https://nixos.org/manual/nixos/stable/#module-services-keycloak-tls)[Themes](https://nixos.org/manual/nixos/stable/#module-services-keycloak-themes)[Configuration file settings](https://nixos.org/manual/nixos/stable/#module-services-keycloak-settings)[Example configuration](https://nixos.org/manual/nixos/stable/#module-services-keycloak-example-config)
...
[Basic usage](https://nixos.org/manual/nixos/stable/#module-services-jitsi-basic-usage)[Configuration](https://nixos.org/manual/nixos/stable/#module-services-jitsi-configuration)
...
[Basic usage](https://nixos.org/manual/nixos/stable/#module-services-grocy-basic-usage)[Settings](https://nixos.org/manual/nixos/stable/#module-services-grocy-settings)
...
[Service configuration](https://nixos.org/manual/nixos/stable/#modules-services-gotosocial-service-configuration)[Proxy configuration](https://nixos.org/manual/nixos/stable/#modules-services-gotosocial-proxy-configuration)[User management](https://nixos.org/manual/nixos/stable/#modules-services-gotosocial-user-management)
...
Please refer to [_SSL/TLS Certificates with ACME_](https://nixos.org/manual/nixos/stable/#module-security-acme "SSL/TLS Certificates with ACME") for details on how to provision an SSL/TLS certificate.
...
[Basic usage](https://nixos.org/manual/nixos/stable/#module-services-discourse-basic-usage)[Using a regular TLS certificate](https://nixos.org/manual/nixos/stable/#module-services-discourse-tls)[Database access](https://nixos.org/manual/nixos/stable/#module-services-discourse-database)[Email](https://nixos.org/manual/nixos/stable/#module-services-discourse-mail)[Additional settings](https://nixos.org/manual/nixos/stable/#module-services-discourse-settings)[Plugins](https://nixos.org/manual/nixos/stable/#module-services-discourse-plugins)
...
### Site settings [](https://nixos.org/manual/nixos/stable/#module-services-discourse-site-settings)

“Site settings” are the settings that can be changed through the Discourse UI. Their _default_ values can be set using [`services.discourse.siteSettings`](https://nixos.org/manual/nixos/stable/options#opt-services.discourse.siteSettings).
...
### Backend settings [](https://nixos.org/manual/nixos/stable/#module-services-discourse-backend-settings)
...
### Example [](https://nixos.org/manual/nixos/stable/#module-services-discourse-settings-example)
...
Some plugins provide [site settings](https://nixos.org/manual/nixos/stable/#module-services-discourse-site-settings "Site settings"). Their defaults can be configured using [`services.discourse.siteSettings`](https://nixos.org/manual/nixos/stable/options#opt-services.discourse.siteSettings), just like regular site settings. To find the names of these settings, look in the `config/settings.yml` file of the plugin repo.
...
Configure ACME ([https://nixos.org/manual/nixos/unstable/#module-security-acme](https://nixos.org/manual/nixos/unstable/#module-security-acme)). Use the following configuration to start a public instance of Castopod on `castopod.example.com` domain:
...
[Service configuration](https://nixos.org/manual/nixos/stable/#modules-services-akkoma-service-configuration)[User management](https://nixos.org/manual/nixos/stable/#modules-services-akkoma-user-management)[Proxy configuration](https://nixos.org/manual/nixos/stable/#modules-services-akkoma-proxy-configuration)[Frontend management](https://nixos.org/manual/nixos/stable/#modules-services-akkoma-frontend-management)[Federation policies](https://nixos.org/manual/nixos/stable/#modules-services-akkoma-federation-policies)[Upload filters](https://nixos.org/manual/nixos/stable/#modules-services-akkoma-upload-filters)[Migration from Pleroma](https://nixos.org/manual/nixos/stable/#modules-services-akkoma-migration-pleroma)[Advanced deployment options](https://nixos.org/manual/nixos/stable/#modules-services-akkoma-advanced-deployment)
...
### Media proxy [](https://nixos.org/manual/nixos/stable/#modules-services-akkoma-media-proxy)
...
#### Prefetch remote media [](https://nixos.org/manual/nixos/stable/#modules-services-akkoma-prefetch-remote-media)
...
#### Media previews [](https://nixos.org/manual/nixos/stable/#modules-services-akkoma-media-previews)
...
### Copying data [](https://nixos.org/manual/nixos/stable/#modules-services-akkoma-migration-pleroma-copy)
...
### Re‐using data [](https://nixos.org/manual/nixos/stable/#modules-services-akkoma-migration-pleroma-reuse)
...
### Confinement [](https://nixos.org/manual/nixos/stable/#modules-services-akkoma-confinement)
...
### Distributed deployment [](https://nixos.org/manual/nixos/stable/#modules-services-akkoma-distributed-deployment)
...
[Usage](https://nixos.org/manual/nixos/stable/#module-services-kerberos-server-usage)[Notes](https://nixos.org/manual/nixos/stable/#module-services-kerberos-server-notes)[Upstream Documentation](https://nixos.org/manual/nixos/stable/#module-services-kerberos-server-upstream-documentation)
...
*   MIT Kerberos homepage: [https://web.mit.edu/kerberos](https://web.mit.edu/kerberos)

*   MIT Kerberos docs: [https://web.mit.edu/kerberos/krb5-latest/doc/index.html](https://web.mit.edu/kerberos/krb5-latest/doc/index.html)

*   Heimdal Kerberos GitHub wiki: [https://github.com/heimdal/heimdal/wiki](https://github.com/heimdal/heimdal/wiki)

*   Heimdal kerberos doc manpages (Debian unstable): [https://manpages.debian.org/unstable/heimdal-docs/index.html](https://manpages.debian.org/unstable/heimdal-docs/index.html)

*   Heimdal Kerberos kdc manpages (Debian unstable): [https://manpages.debian.org/unstable/heimdal-kdc/index.html](https://manpages.debian.org/unstable/heimdal-kdc/index.html)
...
[Quickstart](https://nixos.org/manual/nixos/stable/#module-services-meilisearch-quickstart)[Usage](https://nixos.org/manual/nixos/stable/#module-services-meilisearch-usage)[Defaults](https://nixos.org/manual/nixos/stable/#module-services-meilisearch-defaults)
...
### Add a documents to the `movies` index [](https://nixos.org/manual/nixos/stable/#module-services-meilisearch-quickstart-add)

`curl -X POST 'http://127.0.0.1:7700/indexes/movies/documents' --data '[{"id": "123", "title": "Superman"}, {"id": 234, "title": "Batman"}]'`

### Search documents in the `movies` index [](https://nixos.org/manual/nixos/stable/#module-services-meilisearch-quickstart-search)
...
### Simple ephemeral node [](https://nixos.org/manual/nixos/stable/#module-services-networking-yggdrasil-configuration-simple)
...
### Persistent node with prefix [](https://nixos.org/manual/nixos/stable/#module-services-networking-yggdrasil-configuration-prefix)
...
### Yggdrasil attached Container [](https://nixos.org/manual/nixos/stable/#module-services-networking-yggdrasil-configuration-container)
...
[Basic usage](https://nixos.org/manual/nixos/stable/#module-services-prosody-basic-usage)[Let’s Encrypt Configuration](https://nixos.org/manual/nixos/stable/#module-services-prosody-letsencrypt)
...
As you can see in the code snippet from the [previous section](https://nixos.org/manual/nixos/stable/#module-services-prosody-basic-usage "Basic usage"), you’ll need a single TLS certificate covering your main endpoint, the MUC one as well as the HTTP Upload one. We can generate such a certificate by leveraging the ACME [extraDomainNames](https://nixos.org/manual/nixos/stable/options#opt-security.acme.certs._name_.extraDomainNames) module option.
...
[Generating the Pleroma config](https://nixos.org/manual/nixos/stable/#module-services-pleroma-generate-config)[Initializing the database](https://nixos.org/manual/nixos/stable/#module-services-pleroma-initialize-db)[Enabling the Pleroma service locally](https://nixos.org/manual/nixos/stable/#module-services-pleroma-enable)[Creating the admin user](https://nixos.org/manual/nixos/stable/#module-services-pleroma-admin-user)[Configuring Nginx](https://nixos.org/manual/nixos/stable/#module-services-pleroma-nginx)
...
This is an example of configuration, where [`services.pleroma.configs`](https://nixos.org/manual/nixos/stable/options#opt-services.pleroma.configs) option contains the content of the file `config.exs`, generated [in the first section](https://nixos.org/manual/nixos/stable/#module-services-pleroma-generate-config "Generating the Pleroma config"), but with the secrets (database password, endpoint secret key, salts, etc.) removed. Removing secrets is important, because otherwise they will be stored publicly in the Nix store.
...
[Configuration](https://nixos.org/manual/nixos/stable/#module-services-networking-pihole-ftl-configuration)[Administration](https://nixos.org/manual/nixos/stable/#module-services-networking-pihole-ftl-administration)
...
### Inheriting configuration from Dnsmasq [](https://nixos.org/manual/nixos/stable/#module-services-networking-pihole-ftl-configuration-inherit-dnsmasq)
...
### Serving on multiple interfaces [](https://nixos.org/manual/nixos/stable/#module-services-networking-pihole-ftl-configuration-multiple-interfaces)
...
For more convenient administration and monitoring, see [Pi-hole Dashboard](https://nixos.org/manual/nixos/stable/#module-services-web-apps-pihole-web "Pi-hole Web Dashboard")
...
[Quickstart](https://nixos.org/manual/nixos/stable/#module-services-netbird-quickstart)[Multiple connections setup](https://nixos.org/manual/nixos/stable/#module-services-netbird-multiple-connections)[Exposing services internally on the Netbird network](https://nixos.org/manual/nixos/stable/#module-services-netbird-firewall)
...
### Additional customizations [](https://nixos.org/manual/nixos/stable/#module-services-netbird-customization)
...
[Quickstart](https://nixos.org/manual/nixos/stable/#module-services-mosquitto-quickstart)[Configuration](https://nixos.org/manual/nixos/stable/#module-services-mosquitto-config)
...
### Password authentication [](https://nixos.org/manual/nixos/stable/#module-services-mosquitto-config-passwords)
...
### ACL format [](https://nixos.org/manual/nixos/stable/#module-services-mosquitto-config-acl)
...
[Quick Start](https://nixos.org/manual/nixos/stable/#module-services-jotta-cli-quick-start)[Example Configuration](https://nixos.org/manual/nixos/stable/#module-services-jotta-cli-example-configuration)
...
[Quickstart](https://nixos.org/manual/nixos/stable/#module-services-firefox-syncserver-quickstart)[More detailed setup](https://nixos.org/manual/nixos/stable/#module-services-firefox-syncserver-configuration)[Configuring clients to use this server](https://nixos.org/manual/nixos/stable/#module-services-firefox-syncserver-clients)
...
This will start a sync server that is only accessible locally on the following url: `http://localhost:5000/1.0/sync/1.5`. See [the dedicated section](https://nixos.org/manual/nixos/stable/#module-services-firefox-syncserver-clients "Configuring clients to use this server") to configure your browser to use this sync server.
...
### Firefox desktop [](https://nixos.org/manual/nixos/stable/#module-services-firefox-syncserver-clients-desktop)
...
### Firefox Android [](https://nixos.org/manual/nixos/stable/#module-services-firefox-syncserver-clients-android)
...
See a full configuration in [https://github.com/m13253/dns-over-https/blob/master/doh-server/doh-server.conf](https://github.com/m13253/dns-over-https/blob/master/doh-server/doh-server.conf).
...
[Configuration](https://nixos.org/manual/nixos/stable/#module-services-networking-dnsmasq-configuration)[References](https://nixos.org/manual/nixos/stable/#module-services-networking-dnsmasq-references)
...
### An authoritative DHCP and DNS server on a home network [](https://nixos.org/manual/nixos/stable/#module-services-networking-dnsmasq-configuration-home)
...
[Configuration](https://nixos.org/manual/nixos/stable/#module-services-crab-hole-configuration)[Troubleshooting](https://nixos.org/manual/nixos/stable/#module-services-crab-hole-troubleshooting)
...
### Downstream options [](https://nixos.org/manual/nixos/stable/#module-services-crab-hole-downstream)
...
#### UDP [](https://nixos.org/manual/nixos/stable/#module-services-crab-hole-udp)

UDP is the simplest downstream, but it is not encrypted. If you want encryption, you need to use another protocol. _**Note:** This also opens a TCP port_
...
#### TLS [](https://nixos.org/manual/nixos/stable/#module-services-crab-hole-tls)
...
#### HTTPS [](https://nixos.org/manual/nixos/stable/#module-services-crab-hole-https)
...
_**Note:** this config is untested_
...
#### QUIC [](https://nixos.org/manual/nixos/stable/#module-services-crab-hole-quic)
...
### Upstream options [](https://nixos.org/manual/nixos/stable/#module-services-crab-hole-upstream-options)
...
#### DNSSEC Issues [](https://nixos.org/manual/nixos/stable/#module-services-crab-hole-dnssec)
...
### API [](https://nixos.org/manual/nixos/stable/#module-services-crab-hole-api)
...
### Invalid config [](https://nixos.org/manual/nixos/stable/#module-services-crab-hole-invalid-config)
...
### Permission Error [](https://nixos.org/manual/nixos/stable/#module-services-crab-hole-permission-error)
...
[Quickstart](https://nixos.org/manual/nixos/stable/#module-services-anubis-quickstart)[Configuration](https://nixos.org/manual/nixos/stable/#module-services-anubis-configuration)
...
[Basic Usage](https://nixos.org/manual/nixos/stable/#module-services-samba-basic-usage)[Configuring](https://nixos.org/manual/nixos/stable/#module-services-samba-configuring)
...
### File share [](https://nixos.org/manual/nixos/stable/#module-services-samba-configuring-file-share)
...
[Configuration](https://nixos.org/manual/nixos/stable/#module-services-prometheus-exporters-configuration)[Adding a new exporter](https://nixos.org/manual/nixos/stable/#module-services-prometheus-exporters-new-exporter)[Updating an exporter module](https://nixos.org/manual/nixos/stable/#module-services-prometheus-exporters-update-exporter-module)
...
[Basic usage](https://nixos.org/manual/nixos/stable/#module-services-parsedmarc-basic-usage)[Local mail](https://nixos.org/manual/nixos/stable/#module-services-parsedmarc-local-mail)[Grafana and GeoIP](https://nixos.org/manual/nixos/stable/#module-services-parsedmarc-grafana-geoip)
...
[Service Configuration](https://nixos.org/manual/nixos/stable/#modules-services-certspotter-service-configuration)[Operation](https://nixos.org/manual/nixos/stable/#modules-services-certspotter-operation)[Hooks](https://nixos.org/manual/nixos/stable/#modules-services-certspotter-hooks)
...
[Basic Usage](https://nixos.org/manual/nixos/stable/#module-services-weechat-basic-usage)[Re-attaching to WeeChat](https://nixos.org/manual/nixos/stable/#module-services-weechat-reattach)
...
_The session name can be changed using [services.weechat.sessionName.](https://nixos.org/manual/nixos/stable/options#opt-services.weechat.sessionName)_
...
[Configuration](https://nixos.org/manual/nixos/stable/#module-services-taskserver-configuration)[The nixos-taskserver tool](https://nixos.org/manual/nixos/stable/#module-services-taskserver-nixos-taskserver-tool)[Declarative/automatic CA management](https://nixos.org/manual/nixos/stable/#module-services-taskserver-declarative-ca-management)[Manual CA management](https://nixos.org/manual/nixos/stable/#module-services-taskserver-manual-ca-management)
...
[Prerequisites](https://nixos.org/manual/nixos/stable/#module-services-gitlab-prerequisites)[Configuring](https://nixos.org/manual/nixos/stable/#module-services-gitlab-configuring)[Maintenance](https://nixos.org/manual/nixos/stable/#module-services-gitlab-maintenance)
...
Refer to [Appendix A](https://nixos.org/manual/nixos/stable/options "Appendix A. Configuration Options") for all available configuration options for the [services.gitlab](https://nixos.org/manual/nixos/stable/options#opt-services.gitlab.enable) module.

Maintenance [](https://nixos.org/manual/nixos/stable/#module-services-gitlab-maintenance)
-----------------------------------------------------------------------------------------

### Backups [](https://nixos.org/manual/nixos/stable/#module-services-gitlab-maintenance-backups)
...
### Rake tasks [](https://nixos.org/manual/nixos/stable/#module-services-gitlab-maintenance-rake)
...
### Full-Migration [](https://nixos.org/manual/nixos/stable/#module-forgejo-migration-gitea-default)
...
### Alternatively, keeping the gitea user [](https://nixos.org/manual/nixos/stable/#module-forgejo-migration-gitea-impersonate)
...
[Basic Usage](https://nixos.org/manual/nixos/stable/#module-services-apache-kafka-basic-usage)[KRaft](https://nixos.org/manual/nixos/stable/#module-services-apache-kafka-kraft)[Migrating to settings](https://nixos.org/manual/nixos/stable/#module-services-apache-kafka-migrating-to-settings)
...
*   Removal of `services.apache-kafka.extraProperties` and `services.apache-kafka.serverProperties`
    ...
    *   Until it can be remedied, you _can_ bail out by using [`services.apache-kafka.configFiles.serverProperties`](https://nixos.org/manual/nixos/stable/options#opt-services.apache-kafka.configFiles.serverProperties) to the path of a fully rendered properties file.
...
By default, synced data are stored in _/var/lib/anki-sync-server/\_ankiuser\__. You can change the directory by using `services.anki-sync-server.baseDirectory`
...
[Synapse Homeserver](https://nixos.org/manual/nixos/stable/#module-services-matrix-synapse)[Registering Matrix users](https://nixos.org/manual/nixos/stable/#module-services-matrix-register-users)[Element (formerly known as Riot) Web Client](https://nixos.org/manual/nixos/stable/#module-services-matrix-element-web)
...
[Mjolnir Setup](https://nixos.org/manual/nixos/stable/#module-services-mjolnir-setup)[Synapse Antispam Module](https://nixos.org/manual/nixos/stable/#module-services-mjolnir-matrix-synapse-antispam)
...
### Element Matrix Services (EMS) [](https://nixos.org/manual/nixos/stable/#module-services-mjolnir-setup-ems)
...
[Configuration](https://nixos.org/manual/nixos/stable/#module-services-mautrix-whatsapp-configuration)[Migrating from an older configuration](https://nixos.org/manual/nixos/stable/#module-services-mautrix-whatsapp-migrate-configuration)
...
[Configuration](https://nixos.org/manual/nixos/stable/#module-services-mautrix-signal-configuration)[Migrating from an older configuration](https://nixos.org/manual/nixos/stable/#module-services-mautrix-signal-migrate-configuration)
...
5.   Optionally, set `services.maubot.plugins` to a list of Maubot plugins (full list available at [https://plugins.maubot.xyz/](https://plugins.maubot.xyz/)):
...
### Element Matrix Services (EMS) [](https://nixos.org/manual/nixos/stable/#module-services-draupnir-setup-ems)
...
[Basic usage with Postfix](https://nixos.org/manual/nixos/stable/#module-services-mailman-basic-usage)[Using with other MTAs](https://nixos.org/manual/nixos/stable/#module-services-mailman-other-mtas)
...
[Forcing display modes](https://nixos.org/manual/nixos/stable/#module-hardware-display-modes)[Crafting custom EDID files](https://nixos.org/manual/nixos/stable/#module-hardware-display-edid-custom)[Assigning EDID files to displays](https://nixos.org/manual/nixos/stable/#module-hardware-display-edid-assign)[Pulling files from linuxhw/EDID database](https://nixos.org/manual/nixos/stable/#module-hardware-display-edid-linuxhw)[Using XFree86 Modeline definitions](https://nixos.org/manual/nixos/stable/#module-hardware-display-edid-modelines)[Complete example for Asus PG278Q](https://nixos.org/manual/nixos/stable/#module-hardware-display-pg278q)
...
`hardware.display.edid.linuxhw` utilizes `pkgs.linuxhw-edid-fetcher` to extract EDID files from [https://github.com/linuxhw/EDID](https://github.com/linuxhw/EDID) based on simple string/regexp search identifying exact entries:
...
[Installing Emacs](https://nixos.org/manual/nixos/stable/#module-services-emacs-installing)[Running Emacs as a Service](https://nixos.org/manual/nixos/stable/#module-services-emacs-running)[Configuring Emacs](https://nixos.org/manual/nixos/stable/#module-services-emacs-configuring)
...
Emacs can be installed in the normal way for Nix (see [_Package Management_](https://nixos.org/manual/nixos/stable/#sec-package-management "Package Management")). In addition, a NixOS _service_ can be enabled.

### The Different Releases of Emacs [](https://nixos.org/manual/nixos/stable/#module-services-emacs-releases)
...
### Adding Packages to Emacs [](https://nixos.org/manual/nixos/stable/#module-services-emacs-adding-packages)
...
If you are on NixOS, you can install this particular Emacs for all users by putting the `emacs.nix` file in `/etc/nixos` and adding it to the list of system packages (see [the section called “Declarative Package Management”](https://nixos.org/manual/nixos/stable/#sec-declarative-package-mgmt "Declarative Package Management")). Simply modify your file `configuration.nix` to make it contain:
...
In this case, the next **nixos-rebuild switch** will take care of adding your **emacs** to the `PATH` environment variable (see [_Changing the Configuration_](https://nixos.org/manual/nixos/stable/#sec-changing-config "Changing the Configuration")).
...
### Advanced Emacs Configuration [](https://nixos.org/manual/nixos/stable/#module-services-emacs-advanced)
...
After building this file as shown in [Example 7](https://nixos.org/manual/nixos/stable/#ex-emacsNix "Example 7. Nix expression to build Emacs with packages (emacs.nix)"), you will get an GTK 3-based Emacs binary pre-loaded with your favorite packages.
...
### Enabling the Service [](https://nixos.org/manual/nixos/stable/#module-services-emacs-enabling)
...
### Starting the client [](https://nixos.org/manual/nixos/stable/#module-services-emacs-starting-client)
...
### Configuring the `EDITOR` variable [](https://nixos.org/manual/nixos/stable/#module-services-emacs-editor-variable)
...
### Per-User Enabling of the Service [](https://nixos.org/manual/nixos/stable/#module-services-emacs-per-user)
...
### A Major Mode for Nix Expressions [](https://nixos.org/manual/nixos/stable/#module-services-emacs-major-mode)
...
### Accessing man pages [](https://nixos.org/manual/nixos/stable/#module-services-emacs-man-pages)
...
### Extra dependencies [](https://nixos.org/manual/nixos/stable/#module-services-livebook-extra-dependencies)
...
[Configuring](https://nixos.org/manual/nixos/stable/#module-services-development-athens-configuring)[Basic usage for a caching proxy configuration](https://nixos.org/manual/nixos/stable/#opt-services-development-athens-caching-proxy)
...
[Configuring](https://nixos.org/manual/nixos/stable/#module-services-tigerbeetle-configuring)[Upgrading](https://nixos.org/manual/nixos/stable/#module-services-tigerbeetle-upgrading)
...
[Configuring](https://nixos.org/manual/nixos/stable/#module-services-postgres-configuring)[Initializing](https://nixos.org/manual/nixos/stable/#module-services-postgres-initializing)[Authentication](https://nixos.org/manual/nixos/stable/#module-services-postgres-authentication)[Upgrading](https://nixos.org/manual/nixos/stable/#module-services-postgres-upgrading)[Versioning and End-of-Life](https://nixos.org/manual/nixos/stable/#module-services-postgres-versioning)[`pg_config`](https://nixos.org/manual/nixos/stable/#module-services-postgres-pg_config)[Options](https://nixos.org/manual/nixos/stable/#module-services-postgres-options)[Plugins](https://nixos.org/manual/nixos/stable/#module-services-postgres-plugins)[Procedural Languages](https://nixos.org/manual/nixos/stable/#module-services-postgres-pls)[JIT (Just-In-Time compilation)](https://nixos.org/manual/nixos/stable/#module-services-postgres-jit)[Service hardening](https://nixos.org/manual/nixos/stable/#module-services-postgres-hardening)[Notable differences to upstream](https://nixos.org/manual/nixos/stable/#module-services-postgres-upstream-deviation)
...
*   Even on psql < 15 (or databases migrated to >= 15), it is recommended to manually assign permissions along these lines
    ...
    *   [https://www.postgresql.org/docs/release/15.0/](https://www.postgresql.org/docs/release/15.0/)

    *   [https://www.postgresql.org/docs/15/ddl-schemas.html#DDL-SCHEMAS-PRIV](https://www.postgresql.org/docs/15/ddl-schemas.html#DDL-SCHEMAS-PRIV)

### Assigning ownership [](https://nixos.org/manual/nixos/stable/#module-services-postgres-initializing-ownership)
...
### Assigning extra permissions [](https://nixos.org/manual/nixos/stable/#module-services-postgres-initializing-extra-permissions)
...
#### in database’s setup `postStart`[](https://nixos.org/manual/nixos/stable/#module-services-postgres-initializing-extra-permissions-superuser-post-start)
...
#### in intermediate oneshot service [](https://nixos.org/manual/nixos/stable/#module-services-postgres-initializing-extra-permissions-superuser-oneshot)
...
### User Mapping [](https://nixos.org/manual/nixos/stable/#module-services-postgres-authentication-user-mapping)
...
[Configuring and basic setup](https://nixos.org/manual/nixos/stable/#module-services-foundationdb-configuring)[Scaling processes and backup agents](https://nixos.org/manual/nixos/stable/#module-services-foundationdb-scaling)[Clustering](https://nixos.org/manual/nixos/stable/#module-services-foundationdb-clustering)[Client connectivity](https://nixos.org/manual/nixos/stable/#module-services-foundationdb-connectivity)[Client authorization and TLS](https://nixos.org/manual/nixos/stable/#module-services-foundationdb-authorization)[Backups and Disaster Recovery](https://nixos.org/manual/nixos/stable/#module-services-foundationdb-disaster-recovery)[Known limitations](https://nixos.org/manual/nixos/stable/#module-services-foundationdb-limitations)[Options](https://nixos.org/manual/nixos/stable/#module-services-foundationdb-options)[Full documentation](https://nixos.org/manual/nixos/stable/#module-services-foundationdb-full-docs)
...
[Configuring](https://nixos.org/manual/nixos/stable/#module-services-backup-borgbackup-configuring)[Basic usage for a local backup](https://nixos.org/manual/nixos/stable/#opt-services-backup-borgbackup-local-directory)[Create a borg backup server](https://nixos.org/manual/nixos/stable/#opt-services-backup-create-server)[Backup to the borg repository server](https://nixos.org/manual/nixos/stable/#opt-services-backup-borgbackup-remote-server)[Backup to a hosting service](https://nixos.org/manual/nixos/stable/#opt-services-backup-borgbackup-borgbase)[Vorta backup client for the desktop](https://nixos.org/manual/nixos/stable/#opt-services-backup-borgbackup-vorta)
...
[Introduction](https://nixos.org/manual/nixos/stable/#module-security-tpm2-introduction)[Using the tpm2 NixOS module](https://nixos.org/manual/nixos/stable/#module-security-tpm2-nixosmodule)
...
### Software Architecture [](https://nixos.org/manual/nixos/stable/#module-security-tpm2-introduction-softwarearchitecture)

#### TCTI [](https://nixos.org/manual/nixos/stable/#module-security-tpm2-introduction-softwarearchitecture-tcti)
...
#### Resource Managers [](https://nixos.org/manual/nixos/stable/#module-security-tpm2-introduction-resourcemanagers)
...
#### Higher Level Interfaces [](https://nixos.org/manual/nixos/stable/#module-security-tpm2-introduction-hli)
...
### FAPI Configuration [](https://nixos.org/manual/nixos/stable/#module-security-tpm2-nixosmodule-fapiconfiguration)
...
[Prerequisites](https://nixos.org/manual/nixos/stable/#module-security-acme-prerequisites)[Using ACME certificates in Nginx](https://nixos.org/manual/nixos/stable/#module-security-acme-nginx)[Using ACME certificates in Apache/httpd](https://nixos.org/manual/nixos/stable/#module-security-acme-httpd)[Manual configuration of HTTP-01 validation](https://nixos.org/manual/nixos/stable/#module-security-acme-configuring)[Configuring ACME for DNS validation](https://nixos.org/manual/nixos/stable/#module-security-acme-config-dns)[Using DNS validation with web server virtual hosts](https://nixos.org/manual/nixos/stable/#module-security-acme-config-dns-with-vhosts)[Using ACME with services demanding root owned certificates](https://nixos.org/manual/nixos/stable/#module-security-acme-root-owned)[Regenerating certificates](https://nixos.org/manual/nixos/stable/#module-security-acme-regenerate)[Fixing JWS Verification error](https://nixos.org/manual/nixos/stable/#module-security-acme-fix-jws)[Ensuring dependencies for services that need to be reloaded when a certificate challenges](https://nixos.org/manual/nixos/stable/#module-security-acme-reload-dependencies)
...
You must also set an email address to be used when creating accounts with Let’s Encrypt. You can set this for all certs with [`security.acme.defaults.email`](https://nixos.org/manual/nixos/stable/options#opt-security.acme.defaults.email) and/or on a per-cert basis with [`security.acme.certs.<name>.email`](https://nixos.org/manual/nixos/stable/options#opt-security.acme.certs._name_.email). This address is only used for registration and renewal reminders, and cannot be used to administer the certificates in any way.

Alternatively, you can use a different ACME server by changing the [`security.acme.defaults.server`](https://nixos.org/manual/nixos/stable/options#opt-security.acme.defaults.server) option to a provider of your choosing, or just change the server for one cert with [`security.acme.certs.<name>.server`](https://nixos.org/manual/nixos/stable/options#opt-security.acme.certs._name_.server).
...
Refer to [Appendix A](https://nixos.org/manual/nixos/stable/options "Appendix A. Configuration Options") for all available configuration options for the [security.acme](https://nixos.org/manual/nixos/stable/options#opt-security.acme.certs) module.
...
You must follow the guide above on configuring DNS-01 validation first, however instead of setting the options for one certificate (e.g. [`security.acme.certs.<name>.dnsProvider`](https://nixos.org/manual/nixos/stable/options#opt-security.acme.certs._name_.dnsProvider)) you will set them as defaults (e.g. [`security.acme.defaults.dnsProvider`](https://nixos.org/manual/nixos/stable/options#opt-security.acme.defaults.dnsProvider)).
...
[Basic usage](https://nixos.org/manual/nixos/stable/#module-programs-oh-my-zsh-usage)[Custom additions](https://nixos.org/manual/nixos/stable/#module-programs-oh-my-zsh-additions)[Custom environments](https://nixos.org/manual/nixos/stable/#module-programs-oh-my-zsh-environments)[Package your own customizations](https://nixos.org/manual/nixos/stable/#module-programs-oh-my-zsh-packaging-customizations)
...
[Package](https://nixos.org/manual/nixos/stable/#sec-digitalbitbox-package)[Hardware](https://nixos.org/manual/nixos/stable/#sec-digitalbitbox-hardware-module)
...
and bundles the `digitalbitbox` package (see [the section called “Package”](https://nixos.org/manual/nixos/stable/#sec-digitalbitbox-package "Package")), which contains the `dbb-app` and `dbb-cli` binaries, along with the hardware module (see [the section called “Hardware”](https://nixos.org/manual/nixos/stable/#sec-digitalbitbox-hardware-module "Hardware")) which sets up the necessary udev rules to access the device.
...
[IBus](https://nixos.org/manual/nixos/stable/#module-services-input-methods-ibus)[Fcitx5](https://nixos.org/manual/nixos/stable/#module-services-input-methods-fcitx)[Nabi](https://nixos.org/manual/nixos/stable/#module-services-input-methods-nabi)[Uim](https://nixos.org/manual/nixos/stable/#module-services-input-methods-uim)[Hime](https://nixos.org/manual/nixos/stable/#module-services-input-methods-hime)[Kime](https://nixos.org/manual/nixos/stable/#module-services-input-methods-kime)
...
### Troubleshooting [](https://nixos.org/manual/nixos/stable/#module-services-input-methods-troubleshooting)
...
[All Hardware](https://nixos.org/manual/nixos/stable/#sec-profile-all-hardware)[Base](https://nixos.org/manual/nixos/stable/#sec-profile-base)[Clone Config](https://nixos.org/manual/nixos/stable/#sec-profile-clone-config)[Demo](https://nixos.org/manual/nixos/stable/#sec-profile-demo)[Docker Container](https://nixos.org/manual/nixos/stable/#sec-profile-docker-container)[Graphical](https://nixos.org/manual/nixos/stable/#sec-profile-graphical)[Hardened](https://nixos.org/manual/nixos/stable/#sec-profile-hardened)[Headless](https://nixos.org/manual/nixos/stable/#sec-profile-headless)[Installation Device](https://nixos.org/manual/nixos/stable/#sec-profile-installation-device)[Perlless](https://nixos.org/manual/nixos/stable/#sec-perlless)[Minimal](https://nixos.org/manual/nixos/stable/#sec-profile-minimal)[QEMU Guest](https://nixos.org/manual/nixos/stable/#sec-profile-qemu-guest)
...
This is the profile from which the Docker images are generated. It prepares a working system by importing the [Minimal](https://nixos.org/manual/nixos/stable/#sec-profile-minimal "Minimal") and [Clone Config](https://nixos.org/manual/nixos/stable/#sec-profile-clone-config "Clone Config") profiles, and setting appropriate configuration options that are useful inside a container context, like [`boot.isContainer`](https://nixos.org/manual/nixos/stable/options#opt-boot.isContainer).
...
Provides a basic configuration for installation devices like CDs. This enables redistributable firmware, includes the [Clone Config profile](https://nixos.org/manual/nixos/stable/#sec-profile-clone-config "Clone Config") and a copy of the Nixpkgs channel, so `nixos-install` works out of the box.

Documentation for [Nixpkgs](https://nixos.org/manual/nixos/stable/options#opt-documentation.enable) and [NixOS](https://nixos.org/manual/nixos/stable/options#opt-documentation.nixos.enable) are forcefully enabled (to override the [Minimal profile](https://nixos.org/manual/nixos/stable/#sec-profile-minimal "Minimal") preference); the NixOS manual is shown automatically on TTY 8, udisks is disabled. Autologin is enabled as `nixos` user, while passwordless login as both `root` and `nixos` is possible. Passwordless `sudo` is enabled too. [NetworkManager](https://nixos.org/manual/nixos/stable/options#opt-networking.networkmanager.enable) is enabled and can be configured interactively with `nmtui`.
...
[Using the Mattermost derivation](https://nixos.org/manual/nixos/stable/#sec-mattermost-derivation)[Using Mattermost plugins](https://nixos.org/manual/nixos/stable/#sec-mattermost-plugins)[Building Mattermost plugins](https://nixos.org/manual/nixos/stable/#sec-mattermost-plugins-build)
...
Administration [](https://nixos.org/manual/nixos/stable/#ch-running)
====================================================================
...
[Service Management](https://nixos.org/manual/nixos/stable/#sec-systemctl)[Rebooting and Shutting Down](https://nixos.org/manual/nixos/stable/#sec-rebooting)[User Sessions](https://nixos.org/manual/nixos/stable/#sec-user-sessions)[Control Groups](https://nixos.org/manual/nixos/stable/#sec-cgroups)[Logging](https://nixos.org/manual/nixos/stable/#sec-logging)[Necessary system state](https://nixos.org/manual/nixos/stable/#ch-system-state)[Cleaning the Nix Store](https://nixos.org/manual/nixos/stable/#sec-nix-gc)[Container Management](https://nixos.org/manual/nixos/stable/#ch-containers)[Troubleshooting](https://nixos.org/manual/nixos/stable/#ch-troubleshooting)
...
[Interacting with a running systemd](https://nixos.org/manual/nixos/stable/#sect-nixos-systemd-general)[systemd in NixOS](https://nixos.org/manual/nixos/stable/#sect-nixos-systemd-nixos)
...
The command `systemctl` is the main way to interact with `systemd`. The following paragraphs demonstrate ways to interact with any OS running systemd as init system. NixOS is of no exception. The [next section](https://nixos.org/manual/nixos/stable/#sect-nixos-systemd-nixos "systemd in NixOS") explains NixOS specific things worth knowing.
...
Using `systemctl --user enable syncthing.service` instead of the above, will work, but it’ll use the absolute path of `syncthing.service` for the symlink, and this path is in `/nix/store/.../lib/systemd/user/`. Hence [garbage collection](https://nixos.org/manual/nixos/stable/#sec-nix-gc "Cleaning the Nix Store") will remove that file and you will wind up with a broken symlink in your systemd configuration, which in turn will not make the service / timer start on login.

### Defining custom services [](https://nixos.org/manual/nixos/stable/#sect-nixos-systemd-custom-services)
...
### Template units [](https://nixos.org/manual/nixos/stable/#sect-nixos-systemd-template-units)
...
[NixOS](https://nixos.org/manual/nixos/stable/#sec-nixos-state)[systemd](https://nixos.org/manual/nixos/stable/#sec-systemd-state)[ZFS](https://nixos.org/manual/nixos/stable/#sec-zfs-state)
...
### `/nix`[](https://nixos.org/manual/nixos/stable/#sec-state-nix)
...
### `/boot`[](https://nixos.org/manual/nixos/stable/#sec-state-boot)
...
### Users and groups [](https://nixos.org/manual/nixos/stable/#sec-state-users)
...
### `machine-id(5)`[](https://nixos.org/manual/nixos/stable/#sec-machine-id)
...
### `/var/lib/systemd`[](https://nixos.org/manual/nixos/stable/#sec-var-systemd)
...
### `/var/log/journal/{machine-id}`[](https://nixos.org/manual/nixos/stable/#sec-var-journal)
...
[Imperative Container Management](https://nixos.org/manual/nixos/stable/#sec-imperative-containers)[Declarative Container Specification](https://nixos.org/manual/nixos/stable/#sec-declarative-containers)[Container Networking](https://nixos.org/manual/nixos/stable/#sec-container-networking)
...
[Boot Problems](https://nixos.org/manual/nixos/stable/#sec-boot-problems)[Maintenance Mode](https://nixos.org/manual/nixos/stable/#sec-maintenance-mode)[Rolling Back Configuration Changes](https://nixos.org/manual/nixos/stable/#sec-rollback)[Nix Store Corruption](https://nixos.org/manual/nixos/stable/#sec-nix-store-corruption)[Network Problems](https://nixos.org/manual/nixos/stable/#sec-nix-network-issues)
...
Development [](https://nixos.org/manual/nixos/stable/#ch-development)
=====================================================================
...
[Getting the Sources](https://nixos.org/manual/nixos/stable/#sec-getting-sources)[Writing NixOS Modules](https://nixos.org/manual/nixos/stable/#sec-writing-modules)[Building Specific Parts of NixOS](https://nixos.org/manual/nixos/stable/#sec-building-parts)[Bootspec](https://nixos.org/manual/nixos/stable/#sec-bootspec)[What happens during a system switch?](https://nixos.org/manual/nixos/stable/#sec-switching-systems)[Writing NixOS Documentation](https://nixos.org/manual/nixos/stable/#sec-writing-documentation)[NixOS Tests](https://nixos.org/manual/nixos/stable/#sec-nixos-tests)[Developing the NixOS Test Driver](https://nixos.org/manual/nixos/stable/#chap-developing-the-test-driver)[Testing the Installer](https://nixos.org/manual/nixos/stable/#ch-testing-installer)[Modular Services](https://nixos.org/manual/nixos/stable/#modular-services)
...
[Option Declarations](https://nixos.org/manual/nixos/stable/#sec-option-declarations)[Options Types](https://nixos.org/manual/nixos/stable/#sec-option-types)[Option Definitions](https://nixos.org/manual/nixos/stable/#sec-option-definitions)[Warnings and Assertions](https://nixos.org/manual/nixos/stable/#sec-assertions)[Meta Attributes](https://nixos.org/manual/nixos/stable/#sec-meta-attributes)[Importing Modules](https://nixos.org/manual/nixos/stable/#sec-importing-modules)[Replace Modules](https://nixos.org/manual/nixos/stable/#sec-replace-modules)[Freeform modules](https://nixos.org/manual/nixos/stable/#sec-freeform-modules)[Options for Program Settings](https://nixos.org/manual/nixos/stable/#sec-settings-options)
...
In [_Configuration Syntax_](https://nixos.org/manual/nixos/stable/#sec-configuration-syntax "Configuration Syntax"), we saw the following structure of NixOS modules:
...
This is actually an _abbreviated_ form of module that only defines options, but does not declare any. The structure of full NixOS modules is shown in [Example: Structure of NixOS Modules](https://nixos.org/manual/nixos/stable/#ex-module-syntax "Example 12. Structure of NixOS Modules").
...
### Utility functions for common option patterns [](https://nixos.org/manual/nixos/stable/#sec-option-declarations-util)

#### `mkEnableOption`[](https://nixos.org/manual/nixos/stable/#sec-option-declarations-util-mkEnableOption)
...
#### `mkPackageOption`[](https://nixos.org/manual/nixos/stable/#sec-option-declarations-util-mkPackageOption)
...
By using extensible option types, it is possible to create a placeholder option in the central module ([Example: Extensible type placeholder in the service module](https://nixos.org/manual/nixos/stable/#ex-option-declaration-eot-service "Example 19. Extensible type placeholder in the service module")), and to extend it in each backend module ([Example: Extending `services.xserver.displayManager.enable` in the `gdm` module](https://nixos.org/manual/nixos/stable/#ex-option-declaration-eot-backend-gdm "Example 20. Extending services.xserver.displayManager.enable in the gdm module"), [Example: Extending `services.xserver.displayManager.enable` in the `sddm` module](https://nixos.org/manual/nixos/stable/#ex-option-declaration-eot-backend-sddm "Example 21. Extending services.xserver.displayManager.enable in the sddm module")).
...
### Basic types [](https://nixos.org/manual/nixos/stable/#sec-option-types-basic)
...
This type only validates that the path is not _currently_ in the Nix store. It does NOT prevent the value from being copied to the store later when:
...
If you want to pair these values with more information, possibly of distinct types, consider using a [sum type](https://nixos.org/manual/nixos/stable/#sec-option-types-sums "Sum types").
...
#### Numeric types [](https://nixos.org/manual/nixos/stable/#sec-option-types-numeric)
...
#### String types [](https://nixos.org/manual/nixos/stable/#sec-option-types-string)
...
#### Specialised types [](https://nixos.org/manual/nixos/stable/#sec-option-types-specialised)
...
### Submodule types [](https://nixos.org/manual/nixos/stable/#sec-option-types-submodule)

Submodules are detailed in [Submodule](https://nixos.org/manual/nixos/stable/#section-option-types-submodule "Submodule").
...
### Union types [](https://nixos.org/manual/nixos/stable/#sec-option-types-unions)

A union of types is a type such that a value is valid when it is valid for at least one of those types.

If some values are instances of more than one of the types, it is not possible to distinguish which type they are meant to be instances of. If that’s needed, consider using a [sum type](https://nixos.org/manual/nixos/stable/#sec-option-types-sums "Sum types").
...
### Sum types [](https://nixos.org/manual/nixos/stable/#sec-option-types-sums)
...
If the you’re interested in can be distinguished without a label, you may simplify your value syntax with a [union type](https://nixos.org/manual/nixos/stable/#sec-option-types-unions "Union types") instead.
...
### Composed types [](https://nixos.org/manual/nixos/stable/#sec-option-types-composed)
...
### Submodule [](https://nixos.org/manual/nixos/stable/#section-option-types-submodule)
...
The option set can be defined directly ([Example: Directly defined submodule](https://nixos.org/manual/nixos/stable/#ex-submodule-direct "Example 23. Directly defined submodule")) or as reference ([Example: Submodule defined as a reference](https://nixos.org/manual/nixos/stable/#ex-submodule-reference "Example 24. Submodule defined as a reference")).
...
The `submodule` type is especially interesting when used with composed types like `attrsOf` or `listOf`. When composed with `listOf` ([Example: Declaration of a list of submodules](https://nixos.org/manual/nixos/stable/#ex-submodule-listof-declaration "Example 25. Declaration of a list of submodules")), `submodule` allows multiple definitions of the submodule option set ([Example: Definition of a list of submodules](https://nixos.org/manual/nixos/stable/#ex-submodule-listof-definition "Example 26. Definition of a list of submodules")).
...
When composed with `attrsOf` ([Example: Declaration of attribute sets of submodules](https://nixos.org/manual/nixos/stable/#ex-submodule-attrsof-declaration "Example 27. Declaration of attribute sets of submodules")), `submodule` allows multiple named definitions of the submodule option set ([Example: Definition of attribute sets of submodules](https://nixos.org/manual/nixos/stable/#ex-submodule-attrsof-definition "Example 28. Definition of attribute sets of submodules")).
...
### Extending types [](https://nixos.org/manual/nixos/stable/#sec-option-types-extending)
...
### Custom types [](https://nixos.org/manual/nixos/stable/#sec-option-types-custom)
...
### Delaying Conditionals [](https://nixos.org/manual/nixos/stable/#sec-option-definitions-delaying-conditionals)
...
Note that this is different from [override priorities](https://nixos.org/manual/nixos/stable/#sec-option-definitions-setting-priorities "Setting Priorities"): setting an order does not affect whether the definition is included or not.

### Merging Configurations [](https://nixos.org/manual/nixos/stable/#sec-option-definitions-merging)
...
### Free-floating definitions [](https://nixos.org/manual/nixos/stable/#sec-option-definitions-definitions)
...
### Warnings [](https://nixos.org/manual/nixos/stable/#sec-assertions-warnings)
...
### Assertions [](https://nixos.org/manual/nixos/stable/#sec-assertions-assetions)
...
*   `doc` points to a valid [Nixpkgs-flavored CommonMark](https://nixos.org/manual/nixpkgs/unstable/#sec-contributing-markup) file containing the module documentation. Its contents is automatically added to [Configuration](https://nixos.org/manual/nixos/stable/#ch-configuration "Configuration"). Changes to a module documentation have to be checked to not break building the NixOS manual:
...
The following shows a submodule assigning a freeform type that allows arbitrary attributes with `str` values below `settings`, but also declares an option for the `settings.port` attribute to have it type-checked and assign a default value. See [Example: Declaring a type-checked `settings` attribute](https://nixos.org/manual/nixos/stable/#ex-settings-typed-attrs "Example 33. Declaring a type-checked settings attribute") for a more complete example.
...
### Nix-representable Formats (JSON, YAML, TOML, INI, …) [](https://nixos.org/manual/nixos/stable/#sec-settings-nix-representable)
...
It returns an attrset with a `type`, `generate` function, and a `lib` attset, as specified [below](https://nixos.org/manual/nixos/stable/#pkgs-formats-result). Some of the lib functions will be best understood if you have read the reference specification. You can find this specification here:
...
It returns a set with INI-specific attributes `type` and `generate` as specified [below](https://nixos.org/manual/nixos/stable/#pkgs-formats-result). The type of the input is an _attrset_ of sections; key-value pairs where the key is the section name and the value is the corresponding content which is also an _attrset_ of key-value pairs for the actual key-value mappings of the INI format. The values of the INI atoms are subject to the above parameters (e.g. lists may be transformed into multiple key-value pairs depending on `listToValue`).
...
It returns a set with INI-specific attributes `type` and `generate` as specified [below](https://nixos.org/manual/nixos/stable/#pkgs-formats-result). The type of the input is an _attrset_ of the structure `{ sections = {}; globalSection = {}; }` where _sections_ are several sections as with _pkgs.formats.ini_ and _globalSection_ being just a single attrset of key-value pairs for a single section, the global section which precedes the section definitions.
...
A function taking an attribute set with values and returning a set with XML-specific attributes `type` and `generate` as specified [below](https://nixos.org/manual/nixos/stable/#pkgs-formats-result).
...
It returns a set with Property list (plist) specific attributes `type` and `generate` as specified [below](https://nixos.org/manual/nixos/stable/#pkgs-formats-result).

`pkgs.formats.pythonVars` { }
A function taking an empty attribute set (for future extensibility) and returning a set with python variable specific attributes `type`, `lib`, and `generate` as specified [below](https://nixos.org/manual/nixos/stable/#pkgs-formats-result).
...
It returns a set with Elixir-Config-specific attributes `type`, `lib`, and `generate` as specified [below](https://nixos.org/manual/nixos/stable/#pkgs-formats-result).
...
It returns a set with PHP-Config-specific attributes `type`, `lib`, and `generate` as specified [below](https://nixos.org/manual/nixos/stable/#pkgs-formats-result).
...
#### Option declarations for attributes [](https://nixos.org/manual/nixos/stable/#sec-settings-attrs-options)

Some `settings` attributes may deserve some extra care. They may need a different type, default or merging behavior, or they are essential options that should show their documentation in the manual. This can be done using [the section called “Freeform modules”](https://nixos.org/manual/nixos/stable/#sec-freeform-modules "Freeform modules").
...
[Schema](https://nixos.org/manual/nixos/stable/#sec-bootspec-schema)[Extensions mechanism](https://nixos.org/manual/nixos/stable/#sec-bootspec-extensions)[External bootloaders](https://nixos.org/manual/nixos/stable/#sec-bootspec-external-bootloaders)
...
[Unit handling](https://nixos.org/manual/nixos/stable/#sec-unit-handling)[Activation script](https://nixos.org/manual/nixos/stable/#sec-activation-script)[Non Switchable Systems](https://nixos.org/manual/nixos/stable/#sec-non-switchable-system)[`/etc` via overlay filesystem](https://nixos.org/manual/nixos/stable/#sec-etc-overlay)
...
### Sysinit reactivation [](https://nixos.org/manual/nixos/stable/#sec-sysinit-reactivation)
...
### NixOS snippets [](https://nixos.org/manual/nixos/stable/#sec-activation-script-nixos-snippets)
...
The sources of the [NixOS Manual](https://nixos.org/manual/nixos/stable/ "NixOS Manual") are in the [`nixos/doc/manual`](https://github.com/NixOS/nixpkgs/tree/master/nixos/doc/manual) subdirectory of the Nixpkgs repository.
...
[Writing Tests](https://nixos.org/manual/nixos/stable/#sec-writing-nixos-tests)[Running Tests](https://nixos.org/manual/nixos/stable/#sec-running-nixos-tests)[Running Tests interactively](https://nixos.org/manual/nixos/stable/#sec-running-nixos-tests-interactively)[Linking NixOS tests to packages](https://nixos.org/manual/nixos/stable/#sec-linking-nixos-tests-to-packages)[Testing Hardware Features](https://nixos.org/manual/nixos/stable/#sec-nixos-test-testing-hardware-features)
...
We refer to the whole test above as a test module, whereas the values in [`nodes.<name>`](https://nixos.org/manual/nixos/stable/#test-opt-nodes) are NixOS modules themselves.
...
### Calling a test [](https://nixos.org/manual/nixos/stable/#sec-calling-nixos-tests)

Tests are invoked differently depending on whether the test is part of NixOS or lives in a different project.

#### Testing within NixOS [](https://nixos.org/manual/nixos/stable/#sec-call-nixos-test-in-nixos)
...
#### Testing outside the NixOS project [](https://nixos.org/manual/nixos/stable/#sec-call-nixos-test-outside-nixos)
...
### Configuring the nodes [](https://nixos.org/manual/nixos/stable/#sec-nixos-test-nodes)
...
### Machine objects [](https://nixos.org/manual/nixos/stable/#ssec-machine-objects)
...
This requires [`enableOCR`](https://nixos.org/manual/nixos/stable/#test-opt-enableOCR) to be set to `true`.
...
### Failing tests early [](https://nixos.org/manual/nixos/stable/#ssec-failing-tests-early)
...
### Adding Python packages to the test script [](https://nixos.org/manual/nixos/stable/#ssec-python-packages-in-test-script)
...
### Overriding a test [](https://nixos.org/manual/nixos/stable/#sec-override-nixos-test)

The NixOS test framework returns tests with multiple overriding methods.

`overrideTestDerivation`_function_
Like applying `overrideAttrs` on the [test](https://nixos.org/manual/nixos/stable/#test-opt-test) derivation.

This is a convenience for `extend` with an override on the [`rawTestDerivationArg`](https://nixos.org/manual/nixos/stable/#test-opt-rawTestDerivationArg) option.
...
`module`
A NixOS module to add to all the nodes in the test. Sets test option [`extraBaseModules`](https://nixos.org/manual/nixos/stable/#test-opt-extraBaseModules).

`specialArgs`
An attribute set of arguments to pass to all NixOS modules. These override the existing arguments, as well as any `_module.args.<name>` that the modules may define. Sets test option [`node.specialArgs`](https://nixos.org/manual/nixos/stable/#test-opt-node.specialArgs).
...
Adds new `nixosTest` modules and/or module arguments to the test, which are evaluated together with the existing modules and [built-in options](https://nixos.org/manual/nixos/stable/#sec-test-options-reference "Test Options Reference").
...
### Test Options Reference [](https://nixos.org/manual/nixos/stable/#sec-test-options-reference)

The following options can be used when writing tests.

[](https://nixos.org/manual/nixos/stable/)[](https://nixos.org/manual/nixos/stable/)[`enableDebugHook`](https://nixos.org/manual/nixos/stable/#test-opt-enableDebugHook)
...
```
[](https://nixos.org/manual/nixos/stable/)[`enableOCR`](https://nixos.org/manual/nixos/stable/#test-opt-enableOCR)
Whether to enable Optical Character Recognition functionality for testing graphical programs. See [`Machine objects`](https://nixos.org/manual/nixos/stable/#ssec-machine-objects "Machine objects").
...
```
[](https://nixos.org/manual/nixos/stable/)[`defaults`](https://nixos.org/manual/nixos/stable/#test-opt-defaults)
NixOS configuration that is applied to all [`nodes`](https://nixos.org/manual/nixos/stable/#test-opt-nodes).
...
```
[](https://nixos.org/manual/nixos/stable/)[`driver`](https://nixos.org/manual/nixos/stable/#test-opt-driver)
...
nixos/lib/testing/driver.nix
```
[](https://nixos.org/manual/nixos/stable/)[`extraBaseModules`](https://nixos.org/manual/nixos/stable/#test-opt-extraBaseModules)
...
nixos/lib/testing/nodes.nix
```
[](https://nixos.org/manual/nixos/stable/)[`extraDriverArgs`](https://nixos.org/manual/nixos/stable/#test-opt-extraDriverArgs)
Extra arguments to pass to the test driver.

They become part of [`driver`](https://nixos.org/manual/nixos/stable/#test-opt-driver) via `wrapProgram`.
...
nixos/lib/testing/driver.nix
```
[](https://nixos.org/manual/nixos/stable/)[`extraPythonPackages`](https://nixos.org/manual/nixos/stable/#test-opt-extraPythonPackages)
...
nixos/lib/testing/driver.nix
```
[](https://nixos.org/manual/nixos/stable/)[`globalTimeout`](https://nixos.org/manual/nixos/stable/#test-opt-globalTimeout)
...
nixos/lib/testing/driver.nix
```
[](https://nixos.org/manual/nixos/stable/)[`hostPkgs`](https://nixos.org/manual/nixos/stable/#test-opt-hostPkgs)
...
nixos/lib/testing/driver.nix
```
[](https://nixos.org/manual/nixos/stable/)[`interactive`](https://nixos.org/manual/nixos/stable/#test-opt-interactive)
Tests [can be run interactively](https://nixos.org/manual/nixos/stable/#sec-running-nixos-tests-interactively "Running Tests interactively") using the program in the test derivation’s `.driverInteractive` attribute.
...
For details, see the section about [running tests interactively](https://nixos.org/manual/nixos/stable/#sec-running-nixos-tests-interactively "Running Tests interactively").
...
```
[](https://nixos.org/manual/nixos/stable/)[`meta`](https://nixos.org/manual/nixos/stable/#test-opt-meta)
...
```
[](https://nixos.org/manual/nixos/stable/)[`meta.broken`](https://nixos.org/manual/nixos/stable/#test-opt-meta.broken)
Sets the [`meta.broken`](https://nixos.org/manual/nixpkgs/stable/#var-meta-broken) attribute on the [`test`](https://nixos.org/manual/nixos/stable/#test-opt-test) derivation.
...
nixos/lib/testing/meta.nix
```
[](https://nixos.org/manual/nixos/stable/)[`meta.hydraPlatforms`](https://nixos.org/manual/nixos/stable/#test-opt-meta.hydraPlatforms)
Sets the [`meta.hydraPlatforms`](https://nixos.org/manual/nixpkgs/stable/#var-meta-hydraPlatforms) attribute on the [`test`](https://nixos.org/manual/nixos/stable/#test-opt-test) derivation.
...
nixos/lib/testing/meta.nix
```
[](https://nixos.org/manual/nixos/stable/)[`meta.maintainers`](https://nixos.org/manual/nixos/stable/#test-opt-meta.maintainers)
...
nixos/lib/testing/meta.nix
```
[](https://nixos.org/manual/nixos/stable/)[`meta.platforms`](https://nixos.org/manual/nixos/stable/#test-opt-meta.platforms)
Sets the [`meta.platforms`](https://nixos.org/manual/nixpkgs/stable/#var-meta-platforms) attribute on the [`test`](https://nixos.org/manual/nixos/stable/#test-opt-test) derivation.
...
nixos/lib/testing/meta.nix
```
[](https://nixos.org/manual/nixos/stable/)[`meta.timeout`](https://nixos.org/manual/nixos/stable/#test-opt-meta.timeout)
The [`test`](https://nixos.org/manual/nixos/stable/#test-opt-test)’s [`meta.timeout`](https://nixos.org/manual/nixpkgs/stable/#var-meta-timeout) in seconds.
...
nixos/lib/testing/meta.nix
```
[](https://nixos.org/manual/nixos/stable/)[`name`](https://nixos.org/manual/nixos/stable/#test-opt-name)
The name of the test.

This is used in the derivation names of the [`driver`](https://nixos.org/manual/nixos/stable/#test-opt-driver) and [`test`](https://nixos.org/manual/nixos/stable/#test-opt-test) runner.
...
```
[](https://nixos.org/manual/nixos/stable/)[`node.pkgs`](https://nixos.org/manual/nixos/stable/#test-opt-node.pkgs)
...
nixos/lib/testing/nodes.nix
```
[](https://nixos.org/manual/nixos/stable/)[`node.pkgsReadOnly`](https://nixos.org/manual/nixos/stable/#test-opt-node.pkgsReadOnly)
Whether to make the `nixpkgs.*` options read-only. This is only relevant when [`node.pkgs`](https://nixos.org/manual/nixos/stable/#test-opt-node.pkgs) is set.

Set this to `false` when any of the [`nodes`](https://nixos.org/manual/nixos/stable/#test-opt-nodes) needs to configure any of the `nixpkgs.*` options. This will slow down evaluation of your test a bit.
...
nixos/lib/testing/nodes.nix
```
[](https://nixos.org/manual/nixos/stable/)[`node.specialArgs`](https://nixos.org/manual/nixos/stable/#test-opt-node.specialArgs)
...
nixos/lib/testing/nodes.nix
```
[](https://nixos.org/manual/nixos/stable/)[`nodes`](https://nixos.org/manual/nixos/stable/#test-opt-nodes)
An attribute set of NixOS configuration modules.

The configurations are augmented by the [`defaults`](https://nixos.org/manual/nixos/stable/#test-opt-defaults) option.

They are assigned network addresses according to the `nixos/lib/testing/network.nix` module.

A few special options are available, that aren’t in a plain NixOS configuration. See [Configuring the nodes](https://nixos.org/manual/nixos/stable/#sec-nixos-test-nodes "Configuring the nodes")
...
nixos/lib/testing/nodes.nix
```
[](https://nixos.org/manual/nixos/stable/)[`passthru`](https://nixos.org/manual/nixos/stable/#test-opt-passthru)
...
nixos/lib/testing/run.nix
```
[](https://nixos.org/manual/nixos/stable/)[`qemu.package`](https://nixos.org/manual/nixos/stable/#test-opt-qemu.package)
Which qemu package to use for the virtualisation of [`nodes`](https://nixos.org/manual/nixos/stable/#test-opt-nodes).
...
nixos/lib/testing/driver.nix
```
[](https://nixos.org/manual/nixos/stable/)[`rawTestDerivationArg`](https://nixos.org/manual/nixos/stable/#test-opt-rawTestDerivationArg)
...
nixos/lib/testing/run.nix
```
[](https://nixos.org/manual/nixos/stable/)[`skipLint`](https://nixos.org/manual/nixos/stable/#test-opt-skipLint)
...
nixos/lib/testing/driver.nix
```
[](https://nixos.org/manual/nixos/stable/)[`skipTypeCheck`](https://nixos.org/manual/nixos/stable/#test-opt-skipTypeCheck)
Disable type checking. This must not be enabled for new NixOS tests.

This may speed up your iteration cycle, unless you’re working on the [`testScript`](https://nixos.org/manual/nixos/stable/#test-opt-testScript).
...
nixos/lib/testing/driver.nix
```
[](https://nixos.org/manual/nixos/stable/)[`sshBackdoor.enable`](https://nixos.org/manual/nixos/stable/#test-opt-sshBackdoor.enable)
...
nixos/lib/testing/nodes.nix
```
[](https://nixos.org/manual/nixos/stable/)[`sshBackdoor.vsockOffset`](https://nixos.org/manual/nixos/stable/#test-opt-sshBackdoor.vsockOffset)
...
nixos/lib/testing/nodes.nix
```
[](https://nixos.org/manual/nixos/stable/)[`test`](https://nixos.org/manual/nixos/stable/#test-opt-test)
...
nixos/lib/testing/run.nix
```
[](https://nixos.org/manual/nixos/stable/)[`testScript`](https://nixos.org/manual/nixos/stable/#test-opt-testScript)
...
### Accessing VMs in the sandbox with SSH [](https://nixos.org/manual/nixos/stable/#sec-test-sandbox-breakpoint)

### Note

For debugging with SSH access into the machines, it’s recommended to try using [the interactive driver](https://nixos.org/manual/nixos/stable/#sec-running-nixos-tests-interactively "Running Tests interactively") with its [SSH backdoor](https://nixos.org/manual/nixos/stable/#sec-nixos-test-ssh-access "SSH Access for test machines") first.

This feature is mostly intended to debug flaky test failures that aren’t reproducible elsewhere.

As explained in [the section called “SSH Access for test machines”](https://nixos.org/manual/nixos/stable/#sec-nixos-test-ssh-access "SSH Access for test machines"), it’s possible to configure an SSH backdoor based on AF_VSOCK. This can be used to SSH into a VM of a running build in a sandbox.
...
As described in [the section called “SSH Access for test machines”](https://nixos.org/manual/nixos/stable/#sec-nixos-test-ssh-access "SSH Access for test machines"), the numbers for vsock start at `3` instead of `1`. So the first VM in the network (sorted alphabetically) can be accessed with `vsock/3`.
...
### System Requirements [](https://nixos.org/manual/nixos/stable/#sec-running-nixos-tests-requirements)
...
### Shell access in interactive mode [](https://nixos.org/manual/nixos/stable/#sec-nixos-test-shell-access)
...
### SSH Access for test machines [](https://nixos.org/manual/nixos/stable/#sec-nixos-test-ssh-access)
...
### Port forwarding to NixOS test VMs [](https://nixos.org/manual/nixos/stable/#sec-nixos-test-port-forwarding)
...
### Reuse VM state [](https://nixos.org/manual/nixos/stable/#sec-nixos-test-reuse-vm-state)
...
### Interactive-only test configuration [](https://nixos.org/manual/nixos/stable/#sec-nixos-test-interactive-configuration)
...
### Wi-Fi [](https://nixos.org/manual/nixos/stable/#sec-nixos-test-wifi)
...
#### vwifi server [](https://nixos.org/manual/nixos/stable/#sec-nixos-test-wifi-vwifi-server)
...
#### AP [](https://nixos.org/manual/nixos/stable/#sec-nixos-test-wifi-ap)
...
#### Station [](https://nixos.org/manual/nixos/stable/#sec-nixos-test-wifi-station)
...
#### Monitor [](https://nixos.org/manual/nixos/stable/#sec-nixos-test-wifi-monitor)
...
[Portability](https://nixos.org/manual/nixos/stable/#modular-service-portability)[Composition and Ownership](https://nixos.org/manual/nixos/stable/#modular-service-composition)[Migration](https://nixos.org/manual/nixos/stable/#modular-service-migration)[Writing and Reviewing a Modular Service](https://nixos.org/manual/nixos/stable/#modular-service-review)[Portable Service Options](https://nixos.org/manual/nixos/stable/#modular-service-options-portable)[Systemd-specific Service Options](https://nixos.org/manual/nixos/stable/#modular-service-options-systemd)
...
Crucially, these options have the type [`attrsOf`](https://nixos.org/manual/nixos/stable/#sec-option-types-composed "Composed types")[`submodule`](https://nixos.org/manual/nixos/stable/#sec-option-types-submodule "Submodule types"). The name of the service is the attribute name corresponding to `attrsOf`. The `submodule` is pre-loaded with two modules:
...
[](https://nixos.org/manual/nixos/stable/)[](https://nixos.org/manual/nixos/stable/)[`_module.args`](https://nixos.org/manual/nixos/stable/#service-opt-_module.args)
...
```
[](https://nixos.org/manual/nixos/stable/)[`configData`](https://nixos.org/manual/nixos/stable/#service-opt-configData)
...
```
[](https://nixos.org/manual/nixos/stable/)[`configData.<name>.enable`](https://nixos.org/manual/nixos/stable/#service-opt-configData._name_.enable)
...
```
[](https://nixos.org/manual/nixos/stable/)[`configData.<name>.name`](https://nixos.org/manual/nixos/stable/#service-opt-configData._name_.name)
...
<nixpkgs/nixos/modules/system/service/portable/config-data-item.nix>
```
[](https://nixos.org/manual/nixos/stable/)[`configData.<name>.path`](https://nixos.org/manual/nixos/stable/#service-opt-configData._name_.path)
...
<nixpkgs/nixos/modules/system/service/portable/config-data-item.nix>
```
[](https://nixos.org/manual/nixos/stable/)[`configData.<name>.source`](https://nixos.org/manual/nixos/stable/#service-opt-configData._name_.source)
...
<nixpkgs/nixos/modules/system/service/portable/config-data-item.nix>
```
[](https://nixos.org/manual/nixos/stable/)[`configData.<name>.text`](https://nixos.org/manual/nixos/stable/#service-opt-configData._name_.text)
...
<nixpkgs/nixos/modules/system/service/portable/config-data-item.nix>
```
[](https://nixos.org/manual/nixos/stable/)[`meta.maintainers`](https://nixos.org/manual/nixos/stable/#service-opt-meta.maintainers)
...
_Type:_ list of (maintainer)

_Default:_`[ ]`

_Example:_`[ lib.maintainers.alice lib.maintainers.bob ]`
...
```
[](https://nixos.org/manual/nixos/stable/)[`process.argv`](https://nixos.org/manual/nixos/stable/#service-opt-process.argv)
...
```
[](https://nixos.org/manual/nixos/stable/)[`services`](https://nixos.org/manual/nixos/stable/#service-opt-services)
...
[](https://nixos.org/manual/nixos/stable/)[](https://nixos.org/manual/nixos/stable/)[`_module.args`](https://nixos.org/manual/nixos/stable/#systemd-service-opt-_module.args)
Additional arguments passed to each module in addition to ones like `lib`, `config`, and `pkgs`, `modulesPath`.
...
<nixpkgs/lib/modules.nix>
```
[](https://nixos.org/manual/nixos/stable/)[`systemd.service`](https://nixos.org/manual/nixos/stable/#systemd-service-opt-systemd.service)
...
```
[](https://nixos.org/manual/nixos/stable/)[`systemd.services`](https://nixos.org/manual/nixos/stable/#systemd-service-opt-systemd.services)
...
<nixpkgs/nixos/modules/system/service/systemd/service.nix>
```
[](https://nixos.org/manual/nixos/stable/)[`systemd.socket`](https://nixos.org/manual/nixos/stable/#systemd-service-opt-systemd.socket)
...
<nixpkgs/nixos/modules/system/service/systemd/service.nix>
```
[](https://nixos.org/manual/nixos/stable/)[`systemd.sockets`](https://nixos.org/manual/nixos/stable/#systemd-service-opt-systemd.sockets)
...
Contributing to this manual [](https://nixos.org/manual/nixos/stable/#chap-contributing)
========================================================================================

**Table of Contents**

[Development environment](https://nixos.org/manual/nixos/stable/#sec-contributing-development-env)[Testing redirects](https://nixos.org/manual/nixos/stable/#sec-contributing-redirects)[Contributing to the `configuration.nix` options documentation](https://nixos.org/manual/nixos/stable/#sec-contributing-options)[Contributing to `nixos-*` tools’ manpages](https://nixos.org/manual/nixos/stable/#sec-contributing-nixos-tools)
...
`devmode`[](https://nixos.org/manual/nixos/stable/#sec-contributing-devmode)
----------------------------------------------------------------------------
...
Command lines and arguments [](https://nixos.org/manual/nixos/stable/#ssec-contributing-nixos-tools-cli-and-args)
-----------------------------------------------------------------------------------------------------------------
...
Paths, NixOS options, environment variables [](https://nixos.org/manual/nixos/stable/#ssec-contributing-nixos-tools-options-and-environment)
--------------------------------------------------------------------------------------------------------------------------------------------
...
Code examples and other commands [](https://nixos.org/manual/nixos/stable/#ssec-contributing-nixos-tools-code-examples)
-----------------------------------------------------------------------------------------------------------------------
...
Channels:[unstable (26.05)](https://nixos.org/manual/nixos/unstable)[stable (25.11)](https://nixos.org/manual/nixos/stable)
